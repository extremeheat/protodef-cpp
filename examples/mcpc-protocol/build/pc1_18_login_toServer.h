...
namespace pdef::pc1_18_login_toServer::toJSON {
bool slot(pdef::Stream &stream, const pdef::pc1_18_login_toServer::slot &obj);
bool particle(pdef::Stream &stream, const pdef::pc1_18_login_toServer::particle &obj);
bool minecraft_smelting_format(pdef::Stream &stream, const pdef::pc1_18_login_toServer::minecraft_smelting_format &obj);
bool tags(pdef::Stream &stream, const pdef::pc1_18_login_toServer::tags &obj);
bool chunkBlockEntity(pdef::Stream &stream, const pdef::pc1_18_login_toServer::chunkBlockEntity &obj);
bool command_node(pdef::Stream &stream, const pdef::pc1_18_login_toServer::command_node &obj);
bool packet_login_start(pdef::Stream &stream, const pdef::pc1_18_login_toServer::packet_login_start &obj);
bool packet_encryption_begin(pdef::Stream &stream, const pdef::pc1_18_login_toServer::packet_encryption_begin &obj);
...
bool tags(pdef::Stream &stream, const pdef::pc1_18_login_toServer::tags &obj) {
  ...
  bool packet_encryption_begin(pdef::Stream &stream, const pdef::pc1_18_login_toServer::packet_encryption_begin &obj) {
    PDEF_JSON_putToken_OR_BAIL("{");
    PDEF_JSON_putBuffer_OR_BAIL(sharedSecret, obj.sharedSecret) /*sharedSecret: buffer*/ /*J4.9*/
  ...
  bool packet_login_plugin_response(pdef::Stream &stream, const pdef::pc1_18_login_toServer::packet_login_plugin_response &obj) {
    ...
    const pdef::pc1_18_login_toServer::packet_login_plugin_response::Data &v_0 = obj.data; /*["packet_login_plugin_response"]*/ /*7.4*/
    {
      ...
      if (V_has == true) { /*8.1*/
        PDEF_JSON_putInt_OR_BAIL(value, (int64_t)v_0.value); /*J0.4*/
      }
    }
    PDEF_JSON_putEndObj_OR_BAIL; PDEF_JSON_FINISH_WRITING; return true;
  }
  bool packet(pdef::Stream &stream, const pdef::pc1_18_login_toServer::packet &obj) {
    ...
    switch (V_name) { /*8.0*/
      case pdef::pc1_18_login_toServer::packet::Name::LoginStart: { /*8.5*/
      PDEF_JSON_putField_OR_BAIL(params_packet_login_start);  pdef::pc1_18_login_toServer::toJSON::packet_login_start(stream, *obj.params_packet_login_start); PDEF_JSON_putToken_OR_BAIL(","); /*packet_login_start*/ /*4.5*/
        break;
      } /*8.7*/
      case pdef::pc1_18_login_toServer::packet::Name::EncryptionBegin: { /*8.5*/
      PDEF_JSON_putField_OR_BAIL(params_packet_encryption_begin);  pdef::pc1_18_login_toServer::toJSON::packet_encryption_begin(stream, *obj.params_packet_encryption_begin); PDEF_JSON_putToken_OR_BAIL(","); /*packet_encryption_begin*/ /*4.5*/
        break;
      } /*8.7*/
      case pdef::pc1_18_login_toServer::packet::Name::LoginPluginResponse: { /*8.5*/
      PDEF_JSON_putField_OR_BAIL(params_packet_login_plugin_response);  pdef::pc1_18_login_toServer::toJSON::packet_login_plugin_response(stream, *obj.params_packet_login_plugin_response); PDEF_JSON_putToken_OR_BAIL(","); /*packet_login_plugin_response*/ /*4.5*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/

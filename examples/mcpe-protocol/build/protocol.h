  ...
  size_t Transaction(pdef::Stream &stream, const pdef::proto::Transaction &obj) {
    ...
    switch (V_transaction_type) { /*8.0*/
      ...
      case pdef::proto::Transaction::TransactionType::ItemUseOnEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.transaction_data_item_use_on_entity); const pdef::proto::Transaction::TransactionDataItemUseOnEntity &v2 = *obj.transaction_data_item_use_on_entity; /*8.6*/
          len += stream.sizeOfVarInt64(v2.entity_runtime_id); /*0.2*/
          len += stream.sizeOfVarInt((int&)v2.action_type); /*action_type: varint*/ /*7.0*/
          len += stream.sizeOfZigZagVarInt(v2.hotbar_slot); /*0.2*/
          size_t len_11 = pdef::proto::size::Item(stream, v2.held_item); EXPECT_OR_BAIL(len_11); len += len_11; /*held_item*/ /*4.4*/
          size_t len_12 = pdef::proto::size::vec3f(stream, v2.player_pos); EXPECT_OR_BAIL(len_12); len += len_12; /*player_pos*/ /*4.4*/
          size_t len_13 = pdef::proto::size::vec3f(stream, v2.click_pos); EXPECT_OR_BAIL(len_13); len += len_13; /*click_pos*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::Transaction::TransactionType::ItemRelease: { /*8.5*/
        EXPECT_OR_BAIL(obj.transaction_data_item_release); const pdef::proto::Transaction::TransactionDataItemRelease &v2 = *obj.transaction_data_item_release; /*8.6*/
          len += stream.sizeOfVarInt((int&)v2.action_type); /*action_type: varint*/ /*7.0*/
          len += stream.sizeOfZigZagVarInt(v2.hotbar_slot); /*0.2*/
          size_t len_14 = pdef::proto::size::Item(stream, v2.held_item); EXPECT_OR_BAIL(len_14); len += len_14; /*held_item*/ /*4.4*/
          size_t len_15 = pdef::proto::size::vec3f(stream, v2.head_pos); EXPECT_OR_BAIL(len_15); len += len_15; /*head_pos*/ /*4.4*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
    ...
    switch (V_type) { /*8.0*/
      case pdef::proto::Recipes::Type::Shapeless: { /*8.5*/
        EXPECT_OR_BAIL(obj.recipe_shapeless_or_shulker_box_or_shapeless_chemistry); const pdef::proto::Recipes::RecipeShapelessOrShulkerBoxOrShapelessChemistry &v2 = *obj.recipe_shapeless_or_shulker_box_or_shapeless_chemistry; /*8.6*/
          ...
          len += 8; /*0.2*/
          len += stream.sizeOfVarInt(v2.block.length());
          len += v2.block.length(); /*block: pstring*/ /*4.1*/
          len += stream.sizeOfZigZagVarInt(v2.priority); /*0.2*/
          len += stream.sizeOfVarInt(v2.network_id); /*0.2*/
        break;
      } /*8.7*/
      ...
      case pdef::proto::Recipes::Type::Furnace: { /*8.5*/
        EXPECT_OR_BAIL(obj.recipe_furnace); const pdef::proto::Recipes::RecipeFurnace &v2 = *obj.recipe_furnace; /*8.6*/
          len += stream.sizeOfZigZagVarInt(v2.input_id); /*0.2*/
          size_t len_26 = pdef::proto::size::ItemLegacy(stream, v2.output); EXPECT_OR_BAIL(len_26); len += len_26; /*output*/ /*4.4*/
          len += stream.sizeOfVarInt(v2.block.length());
          len += v2.block.length(); /*block: pstring*/ /*4.1*/
        break;
      } /*8.7*/
      case pdef::proto::Recipes::Type::FurnaceWithMetadata: { /*8.5*/
        EXPECT_OR_BAIL(obj.recipe_furnace_with_metadata); const pdef::proto::Recipes::RecipeFurnaceWithMetadata &v2 = *obj.recipe_furnace_with_metadata; /*8.6*/
          len += stream.sizeOfZigZagVarInt(v2.input_id); /*0.2*/
          len += stream.sizeOfZigZagVarInt(v2.input_meta); /*0.2*/
          size_t len_27 = pdef::proto::size::ItemLegacy(stream, v2.output); EXPECT_OR_BAIL(len_27); len += len_27; /*output*/ /*4.4*/
          len += stream.sizeOfVarInt(v2.block.length());
          len += v2.block.length(); /*block: pstring*/ /*4.1*/
        break;
      } /*8.7*/
      case pdef::proto::Recipes::Type::Multi: { /*8.5*/
        EXPECT_OR_BAIL(obj.recipe_multi); const pdef::proto::Recipes::RecipeMulti &v2 = *obj.recipe_multi; /*8.6*/
          len += 8; /*0.2*/
          len += stream.sizeOfVarInt(v2.network_id); /*0.2*/
        break;
      } /*8.7*/
    ...
    switch (V_type) { /*8.0*/
      case pdef::proto::PlayerRecords::Type::Add: { /*8.5*/
        EXPECT_OR_BAIL(obj.records_add); const pdef::proto::PlayerRecords::RecordsAdd &v2 = *obj.records_add; /*8.6*/
          ...
          len += stream.sizeOfVarInt(v2.username.length());
          len += v2.username.length(); /*username: pstring*/ /*4.1*/
          len += stream.sizeOfVarInt(v2.xbox_user_id.length());
          len += v2.xbox_user_id.length(); /*xbox_user_id: pstring*/ /*4.1*/
          len += stream.sizeOfVarInt(v2.platform_chat_id.length());
          len += v2.platform_chat_id.length(); /*platform_chat_id: pstring*/ /*4.1*/
          len += 4; /*0.2*/
          size_t len_31 = pdef::proto::size::Skin(stream, v2.skin_data); EXPECT_OR_BAIL(len_31); len += len_31; /*skin_data*/ /*4.4*/
          len += 1; /*0.2*/
          len += 1; /*0.2*/
        break;
      } /*8.7*/
      case pdef::proto::PlayerRecords::Type::Remove: { /*8.5*/
        EXPECT_OR_BAIL(obj.records_remove); const pdef::proto::PlayerRecords::RecordsRemove &v2 = *obj.records_remove; /*8.6*/
          len += 8; /*0.2*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
...
size_t ItemComponentList(pdef::Stream &stream, const pdef::proto::ItemComponentList &obj) {
  ...
  size_t packet_education_settings(pdef::Stream &stream, const pdef::proto::packet_education_settings &obj) {
    ...
    if (V_has_external_link_settings == true) { /*8.1*/
        ...
        len += v2.url.length(); /*url: pstring*/ /*4.1*/
        len += stream.sizeOfVarInt(v2.display_name.length());
        len += v2.display_name.length(); /*display_name: pstring*/ /*4.1*/
    }
    PDEF_SIZE_DBG; return len;
  }
  size_t packet_emote(pdef::Stream &stream, const pdef::proto::packet_emote &obj) {
    ...
    switch (V_has_nbt) { /*8.0*/
      case pdef::proto::ItemExtraDataWithBlockingTick::HasNbt::True: { /*8.5*/
        const pdef::proto::ItemExtraDataWithBlockingTick::Nbt &v2 = *obj.nbt; /*8.5*/
          ...
          WRITE_OR_BAIL(writeByte, (int8_t)v2.nbt); /*0.4*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
...
bool TransactionActions(pdef::Stream &stream, const pdef::proto::TransactionActions &obj, bool allocate = true) {
  ...
  bool Transaction(pdef::Stream &stream, const pdef::proto::Transaction &obj, bool allocate = true) {
    ...
    switch (V_transaction_type) { /*8.0*/
      ...
      case pdef::proto::Transaction::TransactionType::ItemUseOnEntity: { /*8.5*/
        const pdef::proto::Transaction::TransactionDataItemUseOnEntity &v2 = *obj.transaction_data_item_use_on_entity; /*8.5*/
          WRITE_OR_BAIL(writeUnsignedVarLong, (int64_t)v2.entity_runtime_id); /*0.4*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)(int&)v2.action_type); /*7.1*/
          WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.hotbar_slot); /*0.4*/
          pdef::proto::encode::Item(stream, v2.held_item); /*Item*/ /*4.5*/
          pdef::proto::encode::vec3f(stream, v2.player_pos); /*vec3f*/ /*4.5*/
          pdef::proto::encode::vec3f(stream, v2.click_pos); /*vec3f*/ /*4.5*/
        break;
      } /*8.7*/
      case pdef::proto::Transaction::TransactionType::ItemRelease: { /*8.5*/
        const pdef::proto::Transaction::TransactionDataItemRelease &v2 = *obj.transaction_data_item_release; /*8.5*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)(int&)v2.action_type); /*7.1*/
          WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.hotbar_slot); /*0.4*/
          pdef::proto::encode::Item(stream, v2.held_item); /*Item*/ /*4.5*/
          pdef::proto::encode::vec3f(stream, v2.head_pos); /*vec3f*/ /*4.5*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
    ...
    switch (V_type) { /*8.0*/
      case pdef::proto::Recipes::Type::Shapeless: { /*8.5*/
        const pdef::proto::Recipes::RecipeShapelessOrShulkerBoxOrShapelessChemistry &v2 = *obj.recipe_shapeless_or_shulker_box_or_shapeless_chemistry; /*8.5*/
          ...
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.input.size()); /*1.4*/
          for (const auto &v5 : v2.input) { /*3.1*/
            pdef::proto::encode::RecipeIngredient(stream, v5); /*RecipeIngredient*/ /*4.5*/
          }
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.output.size()); /*1.4*/
          for (const auto &v5 : v2.output) { /*3.1*/
            pdef::proto::encode::ItemLegacy(stream, v5); /*ItemLegacy*/ /*4.5*/
          }
          WRITE_OR_BAIL(writeULongBE, (uint64_t)v2.uuid); /*0.4*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.block.length());
          WRITE_OR_BAIL(writeString, v2.block); /*block: pstring*/ /*4.2*/
          WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.priority); /*0.4*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.network_id); /*0.4*/
        break;
      } /*8.7*/
      case pdef::proto::Recipes::Type::ShulkerBox: { /*8.5*/
        const pdef::proto::Recipes::RecipeShapelessOrShulkerBoxOrShapelessChemistry &v2 = *obj.recipe_shapeless_or_shulker_box_or_shapeless_chemistry; /*8.5*/
      ...
      case pdef::proto::Recipes::Type::Furnace: { /*8.5*/
        const pdef::proto::Recipes::RecipeFurnace &v2 = *obj.recipe_furnace; /*8.5*/
          WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.input_id); /*0.4*/
          pdef::proto::encode::ItemLegacy(stream, v2.output); /*ItemLegacy*/ /*4.5*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.block.length());
          WRITE_OR_BAIL(writeString, v2.block); /*block: pstring*/ /*4.2*/
        break;
      } /*8.7*/
      case pdef::proto::Recipes::Type::FurnaceWithMetadata: { /*8.5*/
        const pdef::proto::Recipes::RecipeFurnaceWithMetadata &v2 = *obj.recipe_furnace_with_metadata; /*8.5*/
          WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.input_id); /*0.4*/
          WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.input_meta); /*0.4*/
          pdef::proto::encode::ItemLegacy(stream, v2.output); /*ItemLegacy*/ /*4.5*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.block.length());
          WRITE_OR_BAIL(writeString, v2.block); /*block: pstring*/ /*4.2*/
        break;
      ...
      case pdef::proto::Recipes::Type::Multi: { /*8.5*/
        const pdef::proto::Recipes::RecipeMulti &v2 = *obj.recipe_multi; /*8.5*/
          WRITE_OR_BAIL(writeULongBE, (uint64_t)v2.uuid); /*0.4*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.network_id); /*0.4*/
        break;
      } /*8.7*/
    ...
    switch (V_type) { /*8.0*/
      case pdef::proto::PlayerRecords::Type::Add: { /*8.5*/
        const pdef::proto::PlayerRecords::RecordsAdd &v2 = *obj.records_add; /*8.5*/
          ...
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.username.length());
          WRITE_OR_BAIL(writeString, v2.username); /*username: pstring*/ /*4.2*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.xbox_user_id.length());
          WRITE_OR_BAIL(writeString, v2.xbox_user_id); /*xbox_user_id: pstring*/ /*4.2*/
          WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.platform_chat_id.length());
          WRITE_OR_BAIL(writeString, v2.platform_chat_id); /*platform_chat_id: pstring*/ /*4.2*/
          WRITE_OR_BAIL(writeIntLE, (int32_t)v2.build_platform); /*0.4*/
          pdef::proto::encode::Skin(stream, v2.skin_data); /*Skin*/ /*4.5*/
          WRITE_OR_BAIL(writeBool, (bool)v2.is_teacher); /*0.4*/
          WRITE_OR_BAIL(writeBool, (bool)v2.is_host); /*0.4*/
        break;
      } /*8.7*/
      case pdef::proto::PlayerRecords::Type::Remove: { /*8.5*/
        const pdef::proto::PlayerRecords::RecordsRemove &v2 = *obj.records_remove; /*8.5*/
          WRITE_OR_BAIL(writeULongBE, (uint64_t)v2.uuid); /*0.4*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
...
bool ItemComponentList(pdef::Stream &stream, const pdef::proto::ItemComponentList &obj, bool allocate = true) {
    ...
    switch (V_mode) { /*8.0*/
      case pdef::proto::packet_move_player::Mode::Teleport: { /*8.5*/
        const pdef::proto::packet_move_player::Teleport &v2 = *obj.teleport; /*8.5*/
          ...
          WRITE_OR_BAIL(writeIntLE, (int32_t)(int32_t&)v2.source_entity_type); /*7.1*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
  ...
  bool packet_clientbound_map_item_data(pdef::Stream &stream, const pdef::proto::packet_clientbound_map_item_data &obj, bool allocate = true) {
    ...
    if (V_update_flags.decoration == true) { /*8.2*/
        ...
        WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.decorations.size()); /*1.4*/
        for (const auto &v4 : v2.decorations) { /*3.1*/
    ...
    if (V_update_flags.texture == true) { /*8.2*/
        ...
        WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.width); /*0.4*/
        WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.height); /*0.4*/
        WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.x_offset); /*0.4*/
        WRITE_OR_BAIL(writeZigZagVarInt, (int)v2.y_offset); /*0.4*/
        WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.pixels.size()); /*1.4*/
        for (const auto &v4 : v2.pixels) { /*3.1*/
    ...
    for (const auto &v2 : obj.command_data) { /*5.20*/
      ...
      for (const auto &v3 : v2.overloads) { /*5.20*/
        ...
        for (const auto &v4 : v3.parameters) { /*5.20*/
          ...
          options_val |= (uint8_t)v4.options.unused << 0;
          options_val |= (uint8_t)v4.options.collapse_enum << 1;
          options_val |= (uint8_t)v4.options.has_semantic_constraint << 2;
          options_val |= (uint8_t)v4.options.as_chained_command << 3;
          options_val |= (uint8_t)v4.options.unknown2 << 4;
  ...
  bool packet_education_settings(pdef::Stream &stream, const pdef::proto::packet_education_settings &obj, bool allocate = true) {
    ...
    if (V_has_external_link_settings == true) { /*8.1*/
        ...
        WRITE_OR_BAIL(writeString, v2.url); /*url: pstring*/ /*4.2*/
        WRITE_OR_BAIL(writeUnsignedVarInt, (int)v2.display_name.length());
        WRITE_OR_BAIL(writeString, v2.display_name); /*display_name: pstring*/ /*4.2*/
    }
    return true;
  }
    ...
    switch (V_transaction_type) { /*8.0*/
      ...
      case pdef::proto::Transaction::TransactionType::ItemUseOnEntity: { /*8.5*/
         obj.transaction_data_item_use_on_entity = {}; pdef::proto::Transaction::TransactionDataItemUseOnEntity &v2 = *obj.transaction_data_item_use_on_entity; /*8.4*/
          ...
          pdef::proto::decode::vec3f(stream, v2.player_pos); /*v2*/ /*4.6*/
          pdef::proto::decode::vec3f(stream, v2.click_pos); /*v2*/ /*4.6*/
        break;
      } /*8.7*/
      case pdef::proto::Transaction::TransactionType::ItemRelease: { /*8.5*/
         obj.transaction_data_item_release = {}; pdef::proto::Transaction::TransactionDataItemRelease &v2 = *obj.transaction_data_item_release; /*8.4*/
          ...
          READ_OR_BAIL(readZigZagVarInt, v2.hotbar_slot); /*0.5*/
          pdef::proto::decode::Item(stream, v2.held_item); /*v2*/ /*4.6*/
          pdef::proto::decode::vec3f(stream, v2.head_pos); /*v2*/ /*4.6*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
    ...
    switch (V_type) { /*8.0*/
      case pdef::proto::Recipes::Type::Shapeless: { /*8.5*/
         obj.recipe_shapeless_or_shulker_box_or_shapeless_chemistry = {}; pdef::proto::Recipes::RecipeShapelessOrShulkerBoxOrShapelessChemistry &v2 = *obj.recipe_shapeless_or_shulker_box_or_shapeless_chemistry; /*8.4*/
          ...
          if (!stream.readString(v2.block, block_strlen)) return false; /*block: pstring*/ /*4.3*/
          READ_OR_BAIL(readZigZagVarInt, v2.priority); /*0.5*/
    ...
    switch (V_type) { /*8.0*/
      case pdef::proto::PlayerRecords::Type::Add: { /*8.5*/
         obj.records_add = {}; pdef::proto::PlayerRecords::RecordsAdd &v2 = *obj.records_add; /*8.4*/
          ...
          if (!stream.readString(v2.username, username_strlen)) return false; /*username: pstring*/ /*4.3*/
          int xbox_user_id_strlen; READ_OR_BAIL(readUnsignedVarInt, xbox_user_id_strlen);
          if (!stream.readString(v2.xbox_user_id, xbox_user_id_strlen)) return false; /*xbox_user_id: pstring*/ /*4.3*/
          int platform_chat_id_strlen; READ_OR_BAIL(readUnsignedVarInt, platform_chat_id_strlen);
          if (!stream.readString(v2.platform_chat_id, platform_chat_id_strlen)) return false; /*platform_chat_id: pstring*/ /*4.3*/
          READ_OR_BAIL(readIntLE, v2.build_platform); /*0.5*/
          pdef::proto::decode::Skin(stream, v2.skin_data); /*v2*/ /*4.6*/
          READ_OR_BAIL(readBool, (bool&)v2.is_teacher); /*0.5*/
          READ_OR_BAIL(readBool, (bool&)v2.is_host); /*0.5*/
        break;
      } /*8.7*/
      case pdef::proto::PlayerRecords::Type::Remove: { /*8.5*/
...
bool ItemComponentList(pdef::Stream &stream, pdef::proto::ItemComponentList &obj) {
  ...
  bool packet_education_settings(pdef::Stream &stream, pdef::proto::packet_education_settings &obj) {
    ...
    if (V_has_external_link_settings == true) { /*8.1*/
        ...
        int display_name_strlen; READ_OR_BAIL(readUnsignedVarInt, display_name_strlen);
        if (!stream.readString(v2.display_name, display_name_strlen)) return false; /*display_name: pstring*/ /*4.3*/
    }
    return true;
  }
  bool packet_emote(pdef::Stream &stream, pdef::proto::packet_emote &obj) {
  ...
  bool packet_player_auth_input(pdef::Stream &stream, pdef::proto::packet_player_auth_input &obj) {
    ...
    if (V_input_data.item_interact == true) { /*8.2*/
        ...
        int actions_len; /*2.3*/
        READ_OR_BAIL(readUnsignedVarInt, actions_len); /*2.6*/
        v2.actions.resize(actions_len); /*2.7*/

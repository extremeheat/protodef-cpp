...
bool packet(pdef::Stream &stream, pdef::pc1_18_handshaking_toClient::packet &obj);
  ...
  bool particle(pdef::Stream &stream, pdef::pc1_18_handshaking_toClient::particle &obj) {
    ...
    if (V_particleId == 2) { /*8.2*/
         obj.data_2_or_3_or_24.reset(new pdef::pc1_18_handshaking_toClient::particle::Data2Or3Or24{}); pdef::pc1_18_handshaking_toClient::particle::Data2Or3Or24 &v2 = *obj.data_2_or_3_or_24; /*8.4*/
        ...
        READ_OR_BAIL(readUnsignedVarInt, v2.blockState); /*0.5*/
         ...
         obj.data_14.reset(new pdef::pc1_18_handshaking_toClient::particle::Data14{}); pdef::pc1_18_handshaking_toClient::particle::Data14 &v2 = *obj.data_14; /*8.4*/
        ...
        READ_OR_BAIL(readFloatBE, v2.scale); /*0.5*/
         ...
         obj.data_15.reset(new pdef::pc1_18_handshaking_toClient::particle::Data15{}); pdef::pc1_18_handshaking_toClient::particle::Data15 &v2 = *obj.data_15; /*8.4*/
        ...
        READ_OR_BAIL(readUnsignedVarInt, v2.blockState); /*0.5*/
         ...
         obj.data_35.reset(new pdef::pc1_18_handshaking_toClient::particle::Data35{}); pdef::pc1_18_handshaking_toClient::particle::Data35 &v2 = *obj.data_35; /*8.4*/
        READ_OR_BAIL(readByte, v2.item); /*0.5*/
    }
    else if (V_particleId == 36) { /*8.2*/
         obj.data_36.reset(new pdef::pc1_18_handshaking_toClient::particle::Data36{}); pdef::pc1_18_handshaking_toClient::particle::Data36 &v2 = *obj.data_36; /*8.4*/
        uint64_t origin_val;
...
bool tags(pdef::Stream &stream, pdef::pc1_18_handshaking_toClient::tags &obj) {
  ...
  bool command_node(pdef::Stream &stream, pdef::pc1_18_handshaking_toClient::command_node &obj) {
    ...
    if (V_flags.command_node_type == 0) { /*8.2*/
         ...
         obj.extraNodeData_1.reset(new pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData1{}); pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData1 &v2 = *obj.extraNodeData_1; /*8.4*/
        ...
        if (!stream.readString(v2.name, name_strlen)) return false; /*name: pstring*/ /*4.3*/
         ...
         obj.extraNodeData_2.reset(new pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2{}); pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2 &v2 = *obj.extraNodeData_2; /*8.4*/
        int name_strlen; READ_OR_BAIL(readUnsignedVarInt, name_strlen);
        if (!stream.readString(v2.name, name_strlen)) return false; /*name: pstring*/ /*4.3*/
        ...
        if (V_parser == "brigadier:bool") { /*8.0*/
             ...
             v2.properties_brigadier_float.reset(new pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesBrigadierFloat{}); pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesBrigadierFloat &v4 = *v2.properties_brigadier_float; /*8.4*/
            uint8_t flags_val;
            READ_OR_BAIL(readUByte, flags_val);
            ...
            if (V_flags.max_present == 1) { /*8.2*/
             ...
             v2.properties_brigadier_double.reset(new pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesBrigadierDouble{}); pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesBrigadierDouble &v4 = *v2.properties_brigadier_double; /*8.4*/
            uint8_t flags_val;
            READ_OR_BAIL(readUByte, flags_val);
            v4.flags.unused = flags_val >> 0 & 6;
            v4.flags.max_present = flags_val >> 6 & 1;
            ...
            if (V_flags.max_present == 1) { /*8.2*/
             ...
             v2.properties_brigadier_integer.reset(new pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesBrigadierInteger{}); pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesBrigadierInteger &v4 = *v2.properties_brigadier_integer; /*8.4*/
            uint8_t flags_val;
            READ_OR_BAIL(readUByte, flags_val);
            v4.flags.unused = flags_val >> 0 & 6;
            v4.flags.max_present = flags_val >> 6 & 1;
            ...
            if (V_flags.max_present == 1) { /*8.2*/
             ...
             v2.properties_brigadier_long.reset(new pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesBrigadierLong{}); pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesBrigadierLong &v4 = *v2.properties_brigadier_long; /*8.4*/
            uint8_t flags_val;
            READ_OR_BAIL(readUByte, flags_val);
            v4.flags.unused = flags_val >> 0 & 6;
            v4.flags.max_present = flags_val >> 6 & 1;
          ...
          v2.properties_minecraft_score_holder.allowMultiple = properties_minecraft_score_holder_val >> 7 & 1; /*properties_minecraft_score_holder: bitfield*/ /*4.3*/
             ...
             v2.properties_minecraft_range.reset(new pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesMinecraftRange{}); pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesMinecraftRange &v4 = *v2.properties_minecraft_range; /*8.4*/
            READ_OR_BAIL(readBool, (bool&)v4.allowDecimals); /*0.5*/
             ...
             v2.properties_minecraft_resource_or_tag_or_minecraft_resource.reset(new pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesMinecraftResourceOrTagOrMinecraftResource{}); pdef::pc1_18_handshaking_toClient::command_node::ExtraNodeData2::PropertiesMinecraftResourceOrTagOrMinecraftResource &v4 = *v2.properties_minecraft_resource_or_tag_or_minecraft_resource; /*8.4*/
...
namespace pdef::pc1_18_handshaking_toClient::toJSON {
bool slot(pdef::Stream &stream, const pdef::pc1_18_handshaking_toClient::slot &obj);
bool particle(pdef::Stream &stream, const pdef::pc1_18_handshaking_toClient::particle &obj);
bool minecraft_smelting_format(pdef::Stream &stream, const pdef::pc1_18_handshaking_toClient::minecraft_smelting_format &obj);
bool tags(pdef::Stream &stream, const pdef::pc1_18_handshaking_toClient::tags &obj);
bool chunkBlockEntity(pdef::Stream &stream, const pdef::pc1_18_handshaking_toClient::chunkBlockEntity &obj);
bool command_node(pdef::Stream &stream, const pdef::pc1_18_handshaking_toClient::command_node &obj);
bool packet(pdef::Stream &stream, const pdef::pc1_18_handshaking_toClient::packet &obj);
  bool slot(pdef::Stream &stream, const pdef::pc1_18_handshaking_toClient::slot &obj) {

...
namespace pdef::pc1_18_status_toServer {
...
// optionalNbt is built in
  ...
  struct packet {
    ...
    Name name; /*3.2*/
    std::optional<pdef::pc1_18_status_toServer::packet_ping_start> params_packet_ping_start; /*4.0*/
    std::optional<pdef::pc1_18_status_toServer::packet_ping> params_packet_ping; /*4.0*/
  };
}

namespace pdef::pc1_18_status_toServer::size {
...
size_t minecraft_smelting_format(pdef::Stream &stream, const pdef::pc1_18_status_toServer::minecraft_smelting_format &obj);
size_t tags(pdef::Stream &stream, const pdef::pc1_18_status_toServer::tags &obj);
size_t chunkBlockEntity(pdef::Stream &stream, const pdef::pc1_18_status_toServer::chunkBlockEntity &obj);
size_t command_node(pdef::Stream &stream, const pdef::pc1_18_status_toServer::command_node &obj);
size_t packet_ping_start(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet_ping_start &obj);
size_t packet_ping(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet_ping &obj);
size_t packet(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet &obj);
  ...
  size_t particle(pdef::Stream &stream, const pdef::pc1_18_status_toServer::particle &obj) {
    ...
    if (particleId == 2) { /*8.2*/
        EXPECT_OR_BAIL(obj.data_2_or_3_or_24); const pdef::pc1_18_status_toServer::particle::Data2Or3Or24 &v = *obj.data_2_or_3_or_24; /*8.6*/
        ...
        EXPECT_OR_BAIL(obj.data_14); const pdef::pc1_18_status_toServer::particle::Data14 &v = *obj.data_14; /*8.6*/
        len += 4; /*0.2*/
        len += 4; /*0.2*/
        len += 4; /*0.2*/
        len += 4; /*0.2*/
        ...
        EXPECT_OR_BAIL(obj.data_15); const pdef::pc1_18_status_toServer::particle::Data15 &v = *obj.data_15; /*8.6*/
        len += 4; /*0.2*/
        len += 4; /*0.2*/
        len += 4; /*0.2*/
        len += 4; /*0.2*/
        ...
        EXPECT_OR_BAIL(obj.data_35); const pdef::pc1_18_status_toServer::particle::Data35 &v = *obj.data_35; /*8.6*/
        len += 1; /*0.2*/
    }
    else if (particleId == 36) { /*8.2*/
        EXPECT_OR_BAIL(obj.data_36); const pdef::pc1_18_status_toServer::particle::Data36 &v = *obj.data_36; /*8.6*/
        len += 1; /*origin: bitfield*/ /*4.1*/
        len += stream.sizeOfVarInt(v.positionType.length());
        len += v.positionType.length(); /*positionType^: pstring*/ /*4.1*/
        const pdef::pc1_18_status_toServer::particle::Data36::pstring &positionType = v.positionType; /*0.1*/
        if (positionType == pdef::pc1_18_status_toServer::particle::Data36::PositionType::MinecraftBlock) { /*8.5*/
          len += 1; /*destination: bitfield*/ /*4.1*/
        }
        else if (positionType == pdef::pc1_18_status_toServer::particle::Data36::PositionType::MinecraftEntity) { /*8.5*/
...
size_t tags(pdef::Stream &stream, const pdef::pc1_18_status_toServer::tags &obj) {
  ...
  size_t command_node(pdef::Stream &stream, const pdef::pc1_18_status_toServer::command_node &obj) {
    ...
    const pdef::pc1_18_status_toServer::command_node::bitfield &flags = obj.flags; /*0.1*/
    ...
    if (flags.command_node_type == 0) { /*8.2*/
        ...
        EXPECT_OR_BAIL(obj.extraNodeData_1); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData1 &v = *obj.extraNodeData_1; /*8.6*/
        len += stream.sizeOfVarInt(v.name.length());
        len += v.name.length(); /*name: pstring*/ /*4.1*/
    }
    else if (flags.command_node_type == 2) { /*8.2*/
        EXPECT_OR_BAIL(obj.extraNodeData_2); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2 &v = *obj.extraNodeData_2; /*8.6*/
        len += stream.sizeOfVarInt(v.name.length());
        len += v.name.length(); /*name: pstring*/ /*4.1*/
        len += stream.sizeOfVarInt(v.parser.length());
        len += v.parser.length(); /*parser^: pstring*/ /*4.1*/
        const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::pstring &parser = v.parser; /*0.1*/
        if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierBool) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierFloat) { /*8.5*/
            EXPECT_OR_BAIL(v.properties_brigadier_float); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierFloat &v = *v.properties_brigadier_float; /*8.6*/
            len += 1; /*flags^: bitfield*/ /*4.1*/
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierFloat::bitfield &flags = v.flags; /*0.1*/
        ...
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierDouble) { /*8.5*/
            EXPECT_OR_BAIL(v.properties_brigadier_double); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierDouble &v = *v.properties_brigadier_double; /*8.6*/
            len += 1; /*flags^: bitfield*/ /*4.1*/
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierDouble::bitfield &flags = v.flags; /*0.1*/
            if (flags.min_present == 1) { /*8.2*/
              len += 8; /*0.2*/
            }
            if (flags.max_present == 1) { /*8.2*/
        ...
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierInteger) { /*8.5*/
            EXPECT_OR_BAIL(v.properties_brigadier_integer); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierInteger &v = *v.properties_brigadier_integer; /*8.6*/
            len += 1; /*flags^: bitfield*/ /*4.1*/
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierInteger::bitfield &flags = v.flags; /*0.1*/
            if (flags.min_present == 1) { /*8.2*/
              len += 4; /*0.2*/
            }
            if (flags.max_present == 1) { /*8.2*/
        ...
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierLong) { /*8.5*/
            EXPECT_OR_BAIL(v.properties_brigadier_long); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierLong &v = *v.properties_brigadier_long; /*8.6*/
            len += 1; /*flags^: bitfield*/ /*4.1*/
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierLong::bitfield &flags = v.flags; /*0.1*/
            if (flags.min_present == 1) { /*8.2*/
              len += 8; /*0.2*/
            }
            if (flags.max_present == 1) { /*8.2*/
        ...
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierString) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftEntity) { /*8.5*/
          len += 1; /*properties: bitfield*/ /*4.1*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftGameProfile) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftBlockPos) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftColumnPos) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftVec3) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftVec2) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftBlockState) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftBlockPredicate) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftItemStack) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftItemPredicate) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftColor) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftComponent) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftMessage) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftNbt) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftNbtPath) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftObjective) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftObjectiveCriteria) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftOperation) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftParticle) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftAngle) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftRotation) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftScoreboardSlot) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftScoreHolder) { /*8.5*/
          len += 1; /*properties: bitfield*/ /*4.1*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftSwizzle) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftTeam) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftItemSlot) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftResourceLocation) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftMobEffect) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftFunction) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftEntityAnchor) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftRange) { /*8.5*/
            EXPECT_OR_BAIL(v.properties_minecraft_range); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesMinecraftRange &v = *v.properties_minecraft_range; /*8.6*/
            len += 1; /*0.2*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftIntRange) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftFloatRange) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftItemEnchantment) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftEntitySummon) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftDimension) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftNbtCompoundTag) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftTime) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftResourceOrTag) { /*8.5*/
            EXPECT_OR_BAIL(v.properties_minecraft_resource_or_tag_or_minecraft_resource); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesMinecraftResourceOrTagOrMinecraftResource &v = *v.properties_minecraft_resource_or_tag_or_minecraft_resource; /*8.6*/
            len += stream.sizeOfVarInt(v.registry.length());
            len += v.registry.length(); /*registry: pstring*/ /*4.1*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftResource) { /*8.5*/
            EXPECT_OR_BAIL(v.properties_minecraft_resource_or_tag_or_minecraft_resource); const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesMinecraftResourceOrTagOrMinecraftResource &v = *v.properties_minecraft_resource_or_tag_or_minecraft_resource; /*8.6*/
            len += stream.sizeOfVarInt(v.registry.length());
            len += v.registry.length(); /*registry: pstring*/ /*4.1*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::MinecraftUuid) { /*8.5*/
        }
  ...
  size_t packet(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet &obj) {
    ...
    switch (name) { /*8.0*/
      ...
      case pdef::pc1_18_status_toServer::packet::Name::Ping: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_ping); size_t len_1 = pdef::pc1_18_status_toServer::size::packet_ping(stream, *obj.params_packet_ping); EXPECT_OR_BAIL(len_1); len += len_1; /*params_packet_ping*/ /*4.4*/
        break;
      } /*8.7*/
...
namespace pdef::pc1_18_status_toServer::encode {
bool slot(pdef::Stream &stream, const pdef::pc1_18_status_toServer::slot &obj, bool allocate);
bool particle(pdef::Stream &stream, const pdef::pc1_18_status_toServer::particle &obj, bool allocate);
bool minecraft_smelting_format(pdef::Stream &stream, const pdef::pc1_18_status_toServer::minecraft_smelting_format &obj, bool allocate);
bool tags(pdef::Stream &stream, const pdef::pc1_18_status_toServer::tags &obj, bool allocate);
bool chunkBlockEntity(pdef::Stream &stream, const pdef::pc1_18_status_toServer::chunkBlockEntity &obj, bool allocate);
bool command_node(pdef::Stream &stream, const pdef::pc1_18_status_toServer::command_node &obj, bool allocate);
bool packet_ping_start(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet_ping_start &obj, bool allocate);
bool packet_ping(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet_ping &obj, bool allocate);
bool packet(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet &obj, bool allocate);
  ...
  bool particle(pdef::Stream &stream, const pdef::pc1_18_status_toServer::particle &obj, bool allocate = true) {
    ...
    if (particleId == 2) { /*8.2*/
        const pdef::pc1_18_status_toServer::particle::Data2Or3Or24 &v = *obj.data_2_or_3_or_24; /*8.5*/
        ...
        const pdef::pc1_18_status_toServer::particle::Data14 &v = *obj.data_14; /*8.5*/
        ...
        const pdef::pc1_18_status_toServer::particle::Data15 &v = *obj.data_15; /*8.5*/
        ...
        const pdef::pc1_18_status_toServer::particle::Data35 &v = *obj.data_35; /*8.5*/
        WRITE_OR_BAIL(writeByte, (int8_t)v.item); /*0.4*/
    }
    else if (particleId == 36) { /*8.2*/
        const pdef::pc1_18_status_toServer::particle::Data36 &v = *obj.data_36; /*8.5*/
  ...
  bool minecraft_smelting_format(pdef::Stream &stream, const pdef::pc1_18_status_toServer::minecraft_smelting_format &obj, bool allocate = true) {
    if (allocate) { auto writeSize = pdef::pc1_18_status_toServer::size::minecraft_smelting_format(stream, obj); if (!writeSize) return false; stream.reserve(writeSize); }
...
bool tags(pdef::Stream &stream, const pdef::pc1_18_status_toServer::tags &obj, bool allocate = true) {
  if (allocate) { auto writeSize = pdef::pc1_18_status_toServer::size::tags(stream, obj); if (!writeSize) return false; stream.reserve(writeSize); }
  ...
  bool chunkBlockEntity(pdef::Stream &stream, const pdef::pc1_18_status_toServer::chunkBlockEntity &obj, bool allocate = true) {
    if (allocate) { auto writeSize = pdef::pc1_18_status_toServer::size::chunkBlockEntity(stream, obj); if (!writeSize) return false; stream.reserve(writeSize); }
    uint8_t _3_val = 0;
    _3_val |= obj._3.x << 0;
    _3_val |= obj._3.z << 4;
  ...
  bool command_node(pdef::Stream &stream, const pdef::pc1_18_status_toServer::command_node &obj, bool allocate = true) {
    if (allocate) { auto writeSize = pdef::pc1_18_status_toServer::size::command_node(stream, obj); if (!writeSize) return false; stream.reserve(writeSize); }
    uint8_t flags_val = 0;
    ...
    if (flags.command_node_type == 0) { /*8.2*/
        ...
        const pdef::pc1_18_status_toServer::command_node::ExtraNodeData1 &v = *obj.extraNodeData_1; /*8.5*/
        WRITE_OR_BAIL(writeUnsignedVarInt, (int)v.name.length());
        WRITE_OR_BAIL(writeString, v.name); /*name: pstring*/ /*4.2*/
    }
    else if (flags.command_node_type == 2) { /*8.2*/
        const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2 &v = *obj.extraNodeData_2; /*8.5*/
        WRITE_OR_BAIL(writeUnsignedVarInt, (int)v.name.length());
        WRITE_OR_BAIL(writeString, v.name); /*name: pstring*/ /*4.2*/
        ...
        if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierBool) { /*8.5*/
            ...
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierFloat &v = *v.properties_brigadier_float; /*8.5*/
            uint8_t flags_val = 0;
            ...
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierDouble &v = *v.properties_brigadier_double; /*8.5*/
            uint8_t flags_val = 0;
            flags_val |= v.flags.unused << 0;
            flags_val |= v.flags.max_present << 6;
            flags_val |= v.flags.min_present << 7;
            ...
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierInteger &v = *v.properties_brigadier_integer; /*8.5*/
            uint8_t flags_val = 0;
            flags_val |= v.flags.unused << 0;
            flags_val |= v.flags.max_present << 6;
            flags_val |= v.flags.min_present << 7;
            ...
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierLong &v = *v.properties_brigadier_long; /*8.5*/
            uint8_t flags_val = 0;
            flags_val |= v.flags.unused << 0;
            flags_val |= v.flags.max_present << 6;
            flags_val |= v.flags.min_present << 7;
          ...
          WRITE_OR_BAIL(writeUByte, properties_minecraft_score_holder_val); /*properties_minecraft_score_holder: bitfield*/ /*4.2*/
            ...
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesMinecraftRange &v = *v.properties_minecraft_range; /*8.5*/
            ...
            const pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesMinecraftResourceOrTagOrMinecraftResource &v = *v.properties_minecraft_resource_or_tag_or_minecraft_resource; /*8.5*/
  ...
  bool packet_ping_start(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet_ping_start &obj, bool allocate = true) {
    if (allocate) { auto writeSize = pdef::pc1_18_status_toServer::size::packet_ping_start(stream, obj); if (!writeSize) return false; stream.reserve(writeSize); }
    return true;
  }
  bool packet_ping(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet_ping &obj, bool allocate = true) {
    if (allocate) { auto writeSize = pdef::pc1_18_status_toServer::size::packet_ping(stream, obj); if (!writeSize) return false; stream.reserve(writeSize); }
  ...
  bool packet(pdef::Stream &stream, const pdef::pc1_18_status_toServer::packet &obj, bool allocate = true) {
    ...
    switch (name) { /*8.0*/
      ...
      case pdef::pc1_18_status_toServer::packet::Name::Ping: { /*8.5*/
        pdef::pc1_18_status_toServer::encode::packet_ping(stream, *obj.params_packet_ping); /*packet_ping*/ /*4.5*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
...
namespace pdef::pc1_18_status_toServer::decode {
...
bool minecraft_smelting_format(pdef::Stream &stream, pdef::pc1_18_status_toServer::minecraft_smelting_format &obj);
bool tags(pdef::Stream &stream, pdef::pc1_18_status_toServer::tags &obj);
bool chunkBlockEntity(pdef::Stream &stream, pdef::pc1_18_status_toServer::chunkBlockEntity &obj);
bool command_node(pdef::Stream &stream, pdef::pc1_18_status_toServer::command_node &obj);
bool packet_ping_start(pdef::Stream &stream, pdef::pc1_18_status_toServer::packet_ping_start &obj);
bool packet_ping(pdef::Stream &stream, pdef::pc1_18_status_toServer::packet_ping &obj);
bool packet(pdef::Stream &stream, pdef::pc1_18_status_toServer::packet &obj);
  ...
  bool particle(pdef::Stream &stream, pdef::pc1_18_status_toServer::particle &obj) {
    ...
    if (particleId == 2) { /*8.2*/
         obj.data_2_or_3_or_24 = {}; pdef::pc1_18_status_toServer::particle::Data2Or3Or24 &v = *obj.data_2_or_3_or_24; /*8.4*/
        ...
        READ_OR_BAIL(readUnsignedVarInt, v.blockState); /*0.5*/
         ...
         obj.data_14 = {}; pdef::pc1_18_status_toServer::particle::Data14 &v = *obj.data_14; /*8.4*/
        ...
        READ_OR_BAIL(readFloatBE, v.scale); /*0.5*/
         ...
         obj.data_15 = {}; pdef::pc1_18_status_toServer::particle::Data15 &v = *obj.data_15; /*8.4*/
        ...
        READ_OR_BAIL(readUnsignedVarInt, v.blockState); /*0.5*/
         ...
         obj.data_35 = {}; pdef::pc1_18_status_toServer::particle::Data35 &v = *obj.data_35; /*8.4*/
        READ_OR_BAIL(readByte, v.item); /*0.5*/
    }
    else if (particleId == 36) { /*8.2*/
         obj.data_36 = {}; pdef::pc1_18_status_toServer::particle::Data36 &v = *obj.data_36; /*8.4*/
        uint8_t origin_val;
        ...
        pdef::pc1_18_status_toServer::particle::Data36::pstring &positionType = v.positionType; /*0.7*/
        if (positionType == pdef::pc1_18_status_toServer::particle::Data36::PositionType::MinecraftBlock) { /*8.5*/
...
bool tags(pdef::Stream &stream, pdef::pc1_18_status_toServer::tags &obj) {
  ...
  bool command_node(pdef::Stream &stream, pdef::pc1_18_status_toServer::command_node &obj) {
    ...
    pdef::pc1_18_status_toServer::command_node::bitfield &flags = obj.flags; /*0.7*/
    ...
    if (flags.command_node_type == 0) { /*8.2*/
         ...
         obj.extraNodeData_1 = {}; pdef::pc1_18_status_toServer::command_node::ExtraNodeData1 &v = *obj.extraNodeData_1; /*8.4*/
        ...
        if (!stream.readString(v.name, name_strlen)) return false; /*name: pstring*/ /*4.3*/
         ...
         obj.extraNodeData_2 = {}; pdef::pc1_18_status_toServer::command_node::ExtraNodeData2 &v = *obj.extraNodeData_2; /*8.4*/
        int name_strlen; READ_OR_BAIL(readUnsignedVarInt, name_strlen);
        if (!stream.readString(v.name, name_strlen)) return false; /*name: pstring*/ /*4.3*/
        ...
        pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::pstring &parser = v.parser; /*0.7*/
        if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierBool) { /*8.5*/
        }
        else if (parser == pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::Parser::BrigadierFloat) { /*8.5*/
             v.properties_brigadier_float = {}; pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierFloat &v = *v.properties_brigadier_float; /*8.4*/
            uint8_t flags_val;
            READ_OR_BAIL(readUByte, flags_val);
            v.flags.unused = flags_val >> 0 & 6;
            v.flags.max_present = flags_val >> 6 & 1;
            v.flags.min_present = flags_val >> 7 & 1; /*flags: bitfield*/ /*4.3*/
            pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierFloat::bitfield &flags = v.flags; /*0.7*/
            if (flags.min_present == 1) { /*8.2*/
            ...
            if (flags.max_present == 1) { /*8.2*/
             ...
             v.properties_brigadier_double = {}; pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierDouble &v = *v.properties_brigadier_double; /*8.4*/
            uint8_t flags_val;
            READ_OR_BAIL(readUByte, flags_val);
            v.flags.unused = flags_val >> 0 & 6;
            v.flags.max_present = flags_val >> 6 & 1;
            v.flags.min_present = flags_val >> 7 & 1; /*flags: bitfield*/ /*4.3*/
            pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierDouble::bitfield &flags = v.flags; /*0.7*/
            if (flags.min_present == 1) { /*8.2*/
            ...
            if (flags.max_present == 1) { /*8.2*/
             ...
             v.properties_brigadier_integer = {}; pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierInteger &v = *v.properties_brigadier_integer; /*8.4*/
            uint8_t flags_val;
            READ_OR_BAIL(readUByte, flags_val);
            v.flags.unused = flags_val >> 0 & 6;
            v.flags.max_present = flags_val >> 6 & 1;
            v.flags.min_present = flags_val >> 7 & 1; /*flags: bitfield*/ /*4.3*/
            pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierInteger::bitfield &flags = v.flags; /*0.7*/
            if (flags.min_present == 1) { /*8.2*/
            ...
            if (flags.max_present == 1) { /*8.2*/
             ...
             v.properties_brigadier_long = {}; pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierLong &v = *v.properties_brigadier_long; /*8.4*/
            uint8_t flags_val;
            READ_OR_BAIL(readUByte, flags_val);
            v.flags.unused = flags_val >> 0 & 6;
            v.flags.max_present = flags_val >> 6 & 1;
            v.flags.min_present = flags_val >> 7 & 1; /*flags: bitfield*/ /*4.3*/
            pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesBrigadierLong::bitfield &flags = v.flags; /*0.7*/
            if (flags.min_present == 1) { /*8.2*/
          ...
          v.properties_minecraft_score_holder.allowMultiple = properties_minecraft_score_holder_val >> 7 & 1; /*properties_minecraft_score_holder: bitfield*/ /*4.3*/
             ...
             v.properties_minecraft_range = {}; pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesMinecraftRange &v = *v.properties_minecraft_range; /*8.4*/
            READ_OR_BAIL(readBool, (bool&)v.allowDecimals); /*0.5*/
             ...
             v.properties_minecraft_resource_or_tag_or_minecraft_resource = {}; pdef::pc1_18_status_toServer::command_node::ExtraNodeData2::PropertiesMinecraftResourceOrTagOrMinecraftResource &v = *v.properties_minecraft_resource_or_tag_or_minecraft_resource; /*8.4*/
  ...
  bool packet(pdef::Stream &stream, pdef::pc1_18_status_toServer::packet &obj) {
    ...
    switch (name) { /*8.0*/
      ...
      case pdef::pc1_18_status_toServer::packet::Name::Ping: { /*8.5*/
        obj.params_packet_ping = {}; pdef::pc1_18_status_toServer::decode::packet_ping(stream, *obj.params_packet_ping); /*obj*/ /*4.6*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/

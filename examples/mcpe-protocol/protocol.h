...
size_t ItemComponentList(pdef::Stream &stream, const pdef::proto::ItemComponentList &obj) {
  ...
  size_t mcpe_packet(pdef::Stream &stream, const pdef::proto::mcpe_packet &obj) {
    ...
    switch (name) { /*8.0*/
      case pdef::proto::mcpe_packet::Name::Login: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_login); size_t len_50 = pdef::proto::size::packet_login(stream, *obj.params_packet_login); EXPECT_OR_BAIL(len_50); len += len_50; /*params_packet_login*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayStatus: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_play_status); size_t len_51 = pdef::proto::size::packet_play_status(stream, *obj.params_packet_play_status); EXPECT_OR_BAIL(len_51); len += len_51; /*params_packet_play_status*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ServerToClientHandshake: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_server_to_client_handshake); size_t len_52 = pdef::proto::size::packet_server_to_client_handshake(stream, *obj.params_packet_server_to_client_handshake); EXPECT_OR_BAIL(len_52); len += len_52; /*params_packet_server_to_client_handshake*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ClientToServerHandshake: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_client_to_server_handshake); size_t len_53 = pdef::proto::size::packet_client_to_server_handshake(stream, *obj.params_packet_client_to_server_handshake); EXPECT_OR_BAIL(len_53); len += len_53; /*params_packet_client_to_server_handshake*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Disconnect: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_disconnect); size_t len_54 = pdef::proto::size::packet_disconnect(stream, *obj.params_packet_disconnect); EXPECT_OR_BAIL(len_54); len += len_54; /*params_packet_disconnect*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ResourcePacksInfo: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_resource_packs_info); size_t len_55 = pdef::proto::size::packet_resource_packs_info(stream, *obj.params_packet_resource_packs_info); EXPECT_OR_BAIL(len_55); len += len_55; /*params_packet_resource_packs_info*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ResourcePackStack: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_resource_pack_stack); size_t len_56 = pdef::proto::size::packet_resource_pack_stack(stream, *obj.params_packet_resource_pack_stack); EXPECT_OR_BAIL(len_56); len += len_56; /*params_packet_resource_pack_stack*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ResourcePackClientResponse: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_resource_pack_client_response); size_t len_57 = pdef::proto::size::packet_resource_pack_client_response(stream, *obj.params_packet_resource_pack_client_response); EXPECT_OR_BAIL(len_57); len += len_57; /*params_packet_resource_pack_client_response*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Text: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_text); size_t len_58 = pdef::proto::size::packet_text(stream, *obj.params_packet_text); EXPECT_OR_BAIL(len_58); len += len_58; /*params_packet_text*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetTime: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_time); size_t len_59 = pdef::proto::size::packet_set_time(stream, *obj.params_packet_set_time); EXPECT_OR_BAIL(len_59); len += len_59; /*params_packet_set_time*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::StartGame: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_start_game); size_t len_60 = pdef::proto::size::packet_start_game(stream, *obj.params_packet_start_game); EXPECT_OR_BAIL(len_60); len += len_60; /*params_packet_start_game*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AddPlayer: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_add_player); size_t len_61 = pdef::proto::size::packet_add_player(stream, *obj.params_packet_add_player); EXPECT_OR_BAIL(len_61); len += len_61; /*params_packet_add_player*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AddEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_add_entity); size_t len_62 = pdef::proto::size::packet_add_entity(stream, *obj.params_packet_add_entity); EXPECT_OR_BAIL(len_62); len += len_62; /*params_packet_add_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::RemoveEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_remove_entity); size_t len_63 = pdef::proto::size::packet_remove_entity(stream, *obj.params_packet_remove_entity); EXPECT_OR_BAIL(len_63); len += len_63; /*params_packet_remove_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AddItemEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_add_item_entity); size_t len_64 = pdef::proto::size::packet_add_item_entity(stream, *obj.params_packet_add_item_entity); EXPECT_OR_BAIL(len_64); len += len_64; /*params_packet_add_item_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::TakeItemEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_take_item_entity); size_t len_65 = pdef::proto::size::packet_take_item_entity(stream, *obj.params_packet_take_item_entity); EXPECT_OR_BAIL(len_65); len += len_65; /*params_packet_take_item_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MoveEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_move_entity); size_t len_66 = pdef::proto::size::packet_move_entity(stream, *obj.params_packet_move_entity); EXPECT_OR_BAIL(len_66); len += len_66; /*params_packet_move_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MovePlayer: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_move_player); size_t len_67 = pdef::proto::size::packet_move_player(stream, *obj.params_packet_move_player); EXPECT_OR_BAIL(len_67); len += len_67; /*params_packet_move_player*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::RiderJump: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_rider_jump); size_t len_68 = pdef::proto::size::packet_rider_jump(stream, *obj.params_packet_rider_jump); EXPECT_OR_BAIL(len_68); len += len_68; /*params_packet_rider_jump*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdateBlock: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_block); size_t len_69 = pdef::proto::size::packet_update_block(stream, *obj.params_packet_update_block); EXPECT_OR_BAIL(len_69); len += len_69; /*params_packet_update_block*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AddPainting: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_add_painting); size_t len_70 = pdef::proto::size::packet_add_painting(stream, *obj.params_packet_add_painting); EXPECT_OR_BAIL(len_70); len += len_70; /*params_packet_add_painting*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::TickSync: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_tick_sync); size_t len_71 = pdef::proto::size::packet_tick_sync(stream, *obj.params_packet_tick_sync); EXPECT_OR_BAIL(len_71); len += len_71; /*params_packet_tick_sync*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LevelSoundEventOld: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_level_sound_event_old); size_t len_72 = pdef::proto::size::packet_level_sound_event_old(stream, *obj.params_packet_level_sound_event_old); EXPECT_OR_BAIL(len_72); len += len_72; /*params_packet_level_sound_event_old*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LevelEvent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_level_event); size_t len_73 = pdef::proto::size::packet_level_event(stream, *obj.params_packet_level_event); EXPECT_OR_BAIL(len_73); len += len_73; /*params_packet_level_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::BlockEvent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_block_event); size_t len_74 = pdef::proto::size::packet_block_event(stream, *obj.params_packet_block_event); EXPECT_OR_BAIL(len_74); len += len_74; /*params_packet_block_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::EntityEvent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_entity_event); size_t len_75 = pdef::proto::size::packet_entity_event(stream, *obj.params_packet_entity_event); EXPECT_OR_BAIL(len_75); len += len_75; /*params_packet_entity_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MobEffect: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_mob_effect); size_t len_76 = pdef::proto::size::packet_mob_effect(stream, *obj.params_packet_mob_effect); EXPECT_OR_BAIL(len_76); len += len_76; /*params_packet_mob_effect*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdateAttributes: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_attributes); size_t len_77 = pdef::proto::size::packet_update_attributes(stream, *obj.params_packet_update_attributes); EXPECT_OR_BAIL(len_77); len += len_77; /*params_packet_update_attributes*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::InventoryTransaction: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_inventory_transaction); size_t len_78 = pdef::proto::size::packet_inventory_transaction(stream, *obj.params_packet_inventory_transaction); EXPECT_OR_BAIL(len_78); len += len_78; /*params_packet_inventory_transaction*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MobEquipment: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_mob_equipment); size_t len_79 = pdef::proto::size::packet_mob_equipment(stream, *obj.params_packet_mob_equipment); EXPECT_OR_BAIL(len_79); len += len_79; /*params_packet_mob_equipment*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MobArmorEquipment: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_mob_armor_equipment); size_t len_80 = pdef::proto::size::packet_mob_armor_equipment(stream, *obj.params_packet_mob_armor_equipment); EXPECT_OR_BAIL(len_80); len += len_80; /*params_packet_mob_armor_equipment*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Interact: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_interact); size_t len_81 = pdef::proto::size::packet_interact(stream, *obj.params_packet_interact); EXPECT_OR_BAIL(len_81); len += len_81; /*params_packet_interact*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::BlockPickRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_block_pick_request); size_t len_82 = pdef::proto::size::packet_block_pick_request(stream, *obj.params_packet_block_pick_request); EXPECT_OR_BAIL(len_82); len += len_82; /*params_packet_block_pick_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::EntityPickRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_entity_pick_request); size_t len_83 = pdef::proto::size::packet_entity_pick_request(stream, *obj.params_packet_entity_pick_request); EXPECT_OR_BAIL(len_83); len += len_83; /*params_packet_entity_pick_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerAction: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_action); size_t len_84 = pdef::proto::size::packet_player_action(stream, *obj.params_packet_player_action); EXPECT_OR_BAIL(len_84); len += len_84; /*params_packet_player_action*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::HurtArmor: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_hurt_armor); size_t len_85 = pdef::proto::size::packet_hurt_armor(stream, *obj.params_packet_hurt_armor); EXPECT_OR_BAIL(len_85); len += len_85; /*params_packet_hurt_armor*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetEntityData: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_entity_data); size_t len_86 = pdef::proto::size::packet_set_entity_data(stream, *obj.params_packet_set_entity_data); EXPECT_OR_BAIL(len_86); len += len_86; /*params_packet_set_entity_data*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetEntityMotion: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_entity_motion); size_t len_87 = pdef::proto::size::packet_set_entity_motion(stream, *obj.params_packet_set_entity_motion); EXPECT_OR_BAIL(len_87); len += len_87; /*params_packet_set_entity_motion*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetEntityLink: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_entity_link); size_t len_88 = pdef::proto::size::packet_set_entity_link(stream, *obj.params_packet_set_entity_link); EXPECT_OR_BAIL(len_88); len += len_88; /*params_packet_set_entity_link*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetHealth: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_health); size_t len_89 = pdef::proto::size::packet_set_health(stream, *obj.params_packet_set_health); EXPECT_OR_BAIL(len_89); len += len_89; /*params_packet_set_health*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetSpawnPosition: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_spawn_position); size_t len_90 = pdef::proto::size::packet_set_spawn_position(stream, *obj.params_packet_set_spawn_position); EXPECT_OR_BAIL(len_90); len += len_90; /*params_packet_set_spawn_position*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Animate: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_animate); size_t len_91 = pdef::proto::size::packet_animate(stream, *obj.params_packet_animate); EXPECT_OR_BAIL(len_91); len += len_91; /*params_packet_animate*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Respawn: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_respawn); size_t len_92 = pdef::proto::size::packet_respawn(stream, *obj.params_packet_respawn); EXPECT_OR_BAIL(len_92); len += len_92; /*params_packet_respawn*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ContainerOpen: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_container_open); size_t len_93 = pdef::proto::size::packet_container_open(stream, *obj.params_packet_container_open); EXPECT_OR_BAIL(len_93); len += len_93; /*params_packet_container_open*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ContainerClose: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_container_close); size_t len_94 = pdef::proto::size::packet_container_close(stream, *obj.params_packet_container_close); EXPECT_OR_BAIL(len_94); len += len_94; /*params_packet_container_close*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerHotbar: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_hotbar); size_t len_95 = pdef::proto::size::packet_player_hotbar(stream, *obj.params_packet_player_hotbar); EXPECT_OR_BAIL(len_95); len += len_95; /*params_packet_player_hotbar*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::InventoryContent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_inventory_content); size_t len_96 = pdef::proto::size::packet_inventory_content(stream, *obj.params_packet_inventory_content); EXPECT_OR_BAIL(len_96); len += len_96; /*params_packet_inventory_content*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::InventorySlot: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_inventory_slot); size_t len_97 = pdef::proto::size::packet_inventory_slot(stream, *obj.params_packet_inventory_slot); EXPECT_OR_BAIL(len_97); len += len_97; /*params_packet_inventory_slot*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ContainerSetData: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_container_set_data); size_t len_98 = pdef::proto::size::packet_container_set_data(stream, *obj.params_packet_container_set_data); EXPECT_OR_BAIL(len_98); len += len_98; /*params_packet_container_set_data*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CraftingData: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_crafting_data); size_t len_99 = pdef::proto::size::packet_crafting_data(stream, *obj.params_packet_crafting_data); EXPECT_OR_BAIL(len_99); len += len_99; /*params_packet_crafting_data*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CraftingEvent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_crafting_event); size_t len_100 = pdef::proto::size::packet_crafting_event(stream, *obj.params_packet_crafting_event); EXPECT_OR_BAIL(len_100); len += len_100; /*params_packet_crafting_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::GuiDataPickItem: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_gui_data_pick_item); size_t len_101 = pdef::proto::size::packet_gui_data_pick_item(stream, *obj.params_packet_gui_data_pick_item); EXPECT_OR_BAIL(len_101); len += len_101; /*params_packet_gui_data_pick_item*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AdventureSettings: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_adventure_settings); size_t len_102 = pdef::proto::size::packet_adventure_settings(stream, *obj.params_packet_adventure_settings); EXPECT_OR_BAIL(len_102); len += len_102; /*params_packet_adventure_settings*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::BlockEntityData: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_block_entity_data); size_t len_103 = pdef::proto::size::packet_block_entity_data(stream, *obj.params_packet_block_entity_data); EXPECT_OR_BAIL(len_103); len += len_103; /*params_packet_block_entity_data*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerInput: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_input); size_t len_104 = pdef::proto::size::packet_player_input(stream, *obj.params_packet_player_input); EXPECT_OR_BAIL(len_104); len += len_104; /*params_packet_player_input*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LevelChunk: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_level_chunk); size_t len_105 = pdef::proto::size::packet_level_chunk(stream, *obj.params_packet_level_chunk); EXPECT_OR_BAIL(len_105); len += len_105; /*params_packet_level_chunk*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetCommandsEnabled: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_commands_enabled); size_t len_106 = pdef::proto::size::packet_set_commands_enabled(stream, *obj.params_packet_set_commands_enabled); EXPECT_OR_BAIL(len_106); len += len_106; /*params_packet_set_commands_enabled*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetDifficulty: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_difficulty); size_t len_107 = pdef::proto::size::packet_set_difficulty(stream, *obj.params_packet_set_difficulty); EXPECT_OR_BAIL(len_107); len += len_107; /*params_packet_set_difficulty*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ChangeDimension: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_change_dimension); size_t len_108 = pdef::proto::size::packet_change_dimension(stream, *obj.params_packet_change_dimension); EXPECT_OR_BAIL(len_108); len += len_108; /*params_packet_change_dimension*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetPlayerGameType: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_player_game_type); size_t len_109 = pdef::proto::size::packet_set_player_game_type(stream, *obj.params_packet_set_player_game_type); EXPECT_OR_BAIL(len_109); len += len_109; /*params_packet_set_player_game_type*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerList: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_list); size_t len_110 = pdef::proto::size::packet_player_list(stream, *obj.params_packet_player_list); EXPECT_OR_BAIL(len_110); len += len_110; /*params_packet_player_list*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SimpleEvent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_simple_event); size_t len_111 = pdef::proto::size::packet_simple_event(stream, *obj.params_packet_simple_event); EXPECT_OR_BAIL(len_111); len += len_111; /*params_packet_simple_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Event: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_event); size_t len_112 = pdef::proto::size::packet_event(stream, *obj.params_packet_event); EXPECT_OR_BAIL(len_112); len += len_112; /*params_packet_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SpawnExperienceOrb: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_spawn_experience_orb); size_t len_113 = pdef::proto::size::packet_spawn_experience_orb(stream, *obj.params_packet_spawn_experience_orb); EXPECT_OR_BAIL(len_113); len += len_113; /*params_packet_spawn_experience_orb*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ClientboundMapItemData: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_clientbound_map_item_data); size_t len_114 = pdef::proto::size::packet_clientbound_map_item_data(stream, *obj.params_packet_clientbound_map_item_data); EXPECT_OR_BAIL(len_114); len += len_114; /*params_packet_clientbound_map_item_data*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MapInfoRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_map_info_request); size_t len_115 = pdef::proto::size::packet_map_info_request(stream, *obj.params_packet_map_info_request); EXPECT_OR_BAIL(len_115); len += len_115; /*params_packet_map_info_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::RequestChunkRadius: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_request_chunk_radius); size_t len_116 = pdef::proto::size::packet_request_chunk_radius(stream, *obj.params_packet_request_chunk_radius); EXPECT_OR_BAIL(len_116); len += len_116; /*params_packet_request_chunk_radius*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ChunkRadiusUpdate: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_chunk_radius_update); size_t len_117 = pdef::proto::size::packet_chunk_radius_update(stream, *obj.params_packet_chunk_radius_update); EXPECT_OR_BAIL(len_117); len += len_117; /*params_packet_chunk_radius_update*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ItemFrameDropItem: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_item_frame_drop_item); size_t len_118 = pdef::proto::size::packet_item_frame_drop_item(stream, *obj.params_packet_item_frame_drop_item); EXPECT_OR_BAIL(len_118); len += len_118; /*params_packet_item_frame_drop_item*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::GameRulesChanged: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_game_rules_changed); size_t len_119 = pdef::proto::size::packet_game_rules_changed(stream, *obj.params_packet_game_rules_changed); EXPECT_OR_BAIL(len_119); len += len_119; /*params_packet_game_rules_changed*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Camera: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_camera); size_t len_120 = pdef::proto::size::packet_camera(stream, *obj.params_packet_camera); EXPECT_OR_BAIL(len_120); len += len_120; /*params_packet_camera*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::BossEvent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_boss_event); size_t len_121 = pdef::proto::size::packet_boss_event(stream, *obj.params_packet_boss_event); EXPECT_OR_BAIL(len_121); len += len_121; /*params_packet_boss_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ShowCredits: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_show_credits); size_t len_122 = pdef::proto::size::packet_show_credits(stream, *obj.params_packet_show_credits); EXPECT_OR_BAIL(len_122); len += len_122; /*params_packet_show_credits*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AvailableCommands: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_available_commands); size_t len_123 = pdef::proto::size::packet_available_commands(stream, *obj.params_packet_available_commands); EXPECT_OR_BAIL(len_123); len += len_123; /*params_packet_available_commands*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CommandRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_command_request); size_t len_124 = pdef::proto::size::packet_command_request(stream, *obj.params_packet_command_request); EXPECT_OR_BAIL(len_124); len += len_124; /*params_packet_command_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CommandBlockUpdate: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_command_block_update); size_t len_125 = pdef::proto::size::packet_command_block_update(stream, *obj.params_packet_command_block_update); EXPECT_OR_BAIL(len_125); len += len_125; /*params_packet_command_block_update*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CommandOutput: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_command_output); size_t len_126 = pdef::proto::size::packet_command_output(stream, *obj.params_packet_command_output); EXPECT_OR_BAIL(len_126); len += len_126; /*params_packet_command_output*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdateTrade: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_trade); size_t len_127 = pdef::proto::size::packet_update_trade(stream, *obj.params_packet_update_trade); EXPECT_OR_BAIL(len_127); len += len_127; /*params_packet_update_trade*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdateEquipment: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_equipment); size_t len_128 = pdef::proto::size::packet_update_equipment(stream, *obj.params_packet_update_equipment); EXPECT_OR_BAIL(len_128); len += len_128; /*params_packet_update_equipment*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ResourcePackDataInfo: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_resource_pack_data_info); size_t len_129 = pdef::proto::size::packet_resource_pack_data_info(stream, *obj.params_packet_resource_pack_data_info); EXPECT_OR_BAIL(len_129); len += len_129; /*params_packet_resource_pack_data_info*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ResourcePackChunkData: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_resource_pack_chunk_data); size_t len_130 = pdef::proto::size::packet_resource_pack_chunk_data(stream, *obj.params_packet_resource_pack_chunk_data); EXPECT_OR_BAIL(len_130); len += len_130; /*params_packet_resource_pack_chunk_data*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ResourcePackChunkRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_resource_pack_chunk_request); size_t len_131 = pdef::proto::size::packet_resource_pack_chunk_request(stream, *obj.params_packet_resource_pack_chunk_request); EXPECT_OR_BAIL(len_131); len += len_131; /*params_packet_resource_pack_chunk_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Transfer: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_transfer); size_t len_132 = pdef::proto::size::packet_transfer(stream, *obj.params_packet_transfer); EXPECT_OR_BAIL(len_132); len += len_132; /*params_packet_transfer*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlaySound: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_play_sound); size_t len_133 = pdef::proto::size::packet_play_sound(stream, *obj.params_packet_play_sound); EXPECT_OR_BAIL(len_133); len += len_133; /*params_packet_play_sound*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::StopSound: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_stop_sound); size_t len_134 = pdef::proto::size::packet_stop_sound(stream, *obj.params_packet_stop_sound); EXPECT_OR_BAIL(len_134); len += len_134; /*params_packet_stop_sound*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetTitle: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_title); size_t len_135 = pdef::proto::size::packet_set_title(stream, *obj.params_packet_set_title); EXPECT_OR_BAIL(len_135); len += len_135; /*params_packet_set_title*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AddBehaviorTree: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_add_behavior_tree); size_t len_136 = pdef::proto::size::packet_add_behavior_tree(stream, *obj.params_packet_add_behavior_tree); EXPECT_OR_BAIL(len_136); len += len_136; /*params_packet_add_behavior_tree*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::StructureBlockUpdate: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_structure_block_update); size_t len_137 = pdef::proto::size::packet_structure_block_update(stream, *obj.params_packet_structure_block_update); EXPECT_OR_BAIL(len_137); len += len_137; /*params_packet_structure_block_update*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ShowStoreOffer: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_show_store_offer); size_t len_138 = pdef::proto::size::packet_show_store_offer(stream, *obj.params_packet_show_store_offer); EXPECT_OR_BAIL(len_138); len += len_138; /*params_packet_show_store_offer*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PurchaseReceipt: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_purchase_receipt); size_t len_139 = pdef::proto::size::packet_purchase_receipt(stream, *obj.params_packet_purchase_receipt); EXPECT_OR_BAIL(len_139); len += len_139; /*params_packet_purchase_receipt*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerSkin: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_skin); size_t len_140 = pdef::proto::size::packet_player_skin(stream, *obj.params_packet_player_skin); EXPECT_OR_BAIL(len_140); len += len_140; /*params_packet_player_skin*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SubClientLogin: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_sub_client_login); size_t len_141 = pdef::proto::size::packet_sub_client_login(stream, *obj.params_packet_sub_client_login); EXPECT_OR_BAIL(len_141); len += len_141; /*params_packet_sub_client_login*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::InitiateWebSocketConnection: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_initiate_web_socket_connection); size_t len_142 = pdef::proto::size::packet_initiate_web_socket_connection(stream, *obj.params_packet_initiate_web_socket_connection); EXPECT_OR_BAIL(len_142); len += len_142; /*params_packet_initiate_web_socket_connection*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetLastHurtBy: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_last_hurt_by); size_t len_143 = pdef::proto::size::packet_set_last_hurt_by(stream, *obj.params_packet_set_last_hurt_by); EXPECT_OR_BAIL(len_143); len += len_143; /*params_packet_set_last_hurt_by*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::BookEdit: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_book_edit); size_t len_144 = pdef::proto::size::packet_book_edit(stream, *obj.params_packet_book_edit); EXPECT_OR_BAIL(len_144); len += len_144; /*params_packet_book_edit*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::NpcRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_npc_request); size_t len_145 = pdef::proto::size::packet_npc_request(stream, *obj.params_packet_npc_request); EXPECT_OR_BAIL(len_145); len += len_145; /*params_packet_npc_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PhotoTransfer: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_photo_transfer); size_t len_146 = pdef::proto::size::packet_photo_transfer(stream, *obj.params_packet_photo_transfer); EXPECT_OR_BAIL(len_146); len += len_146; /*params_packet_photo_transfer*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ModalFormRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_modal_form_request); size_t len_147 = pdef::proto::size::packet_modal_form_request(stream, *obj.params_packet_modal_form_request); EXPECT_OR_BAIL(len_147); len += len_147; /*params_packet_modal_form_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ModalFormResponse: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_modal_form_response); size_t len_148 = pdef::proto::size::packet_modal_form_response(stream, *obj.params_packet_modal_form_response); EXPECT_OR_BAIL(len_148); len += len_148; /*params_packet_modal_form_response*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ServerSettingsRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_server_settings_request); size_t len_149 = pdef::proto::size::packet_server_settings_request(stream, *obj.params_packet_server_settings_request); EXPECT_OR_BAIL(len_149); len += len_149; /*params_packet_server_settings_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ServerSettingsResponse: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_server_settings_response); size_t len_150 = pdef::proto::size::packet_server_settings_response(stream, *obj.params_packet_server_settings_response); EXPECT_OR_BAIL(len_150); len += len_150; /*params_packet_server_settings_response*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ShowProfile: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_show_profile); size_t len_151 = pdef::proto::size::packet_show_profile(stream, *obj.params_packet_show_profile); EXPECT_OR_BAIL(len_151); len += len_151; /*params_packet_show_profile*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetDefaultGameType: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_default_game_type); size_t len_152 = pdef::proto::size::packet_set_default_game_type(stream, *obj.params_packet_set_default_game_type); EXPECT_OR_BAIL(len_152); len += len_152; /*params_packet_set_default_game_type*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::RemoveObjective: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_remove_objective); size_t len_153 = pdef::proto::size::packet_remove_objective(stream, *obj.params_packet_remove_objective); EXPECT_OR_BAIL(len_153); len += len_153; /*params_packet_remove_objective*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetDisplayObjective: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_display_objective); size_t len_154 = pdef::proto::size::packet_set_display_objective(stream, *obj.params_packet_set_display_objective); EXPECT_OR_BAIL(len_154); len += len_154; /*params_packet_set_display_objective*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetScore: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_score); size_t len_155 = pdef::proto::size::packet_set_score(stream, *obj.params_packet_set_score); EXPECT_OR_BAIL(len_155); len += len_155; /*params_packet_set_score*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LabTable: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_lab_table); size_t len_156 = pdef::proto::size::packet_lab_table(stream, *obj.params_packet_lab_table); EXPECT_OR_BAIL(len_156); len += len_156; /*params_packet_lab_table*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdateBlockSynced: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_block_synced); size_t len_157 = pdef::proto::size::packet_update_block_synced(stream, *obj.params_packet_update_block_synced); EXPECT_OR_BAIL(len_157); len += len_157; /*params_packet_update_block_synced*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MoveEntityDelta: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_move_entity_delta); size_t len_158 = pdef::proto::size::packet_move_entity_delta(stream, *obj.params_packet_move_entity_delta); EXPECT_OR_BAIL(len_158); len += len_158; /*params_packet_move_entity_delta*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetScoreboardIdentity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_scoreboard_identity); size_t len_159 = pdef::proto::size::packet_set_scoreboard_identity(stream, *obj.params_packet_set_scoreboard_identity); EXPECT_OR_BAIL(len_159); len += len_159; /*params_packet_set_scoreboard_identity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SetLocalPlayerAsInitialized: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_set_local_player_as_initialized); size_t len_160 = pdef::proto::size::packet_set_local_player_as_initialized(stream, *obj.params_packet_set_local_player_as_initialized); EXPECT_OR_BAIL(len_160); len += len_160; /*params_packet_set_local_player_as_initialized*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdateSoftEnum: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_soft_enum); size_t len_161 = pdef::proto::size::packet_update_soft_enum(stream, *obj.params_packet_update_soft_enum); EXPECT_OR_BAIL(len_161); len += len_161; /*params_packet_update_soft_enum*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::NetworkStackLatency: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_network_stack_latency); size_t len_162 = pdef::proto::size::packet_network_stack_latency(stream, *obj.params_packet_network_stack_latency); EXPECT_OR_BAIL(len_162); len += len_162; /*params_packet_network_stack_latency*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ScriptCustomEvent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_script_custom_event); size_t len_163 = pdef::proto::size::packet_script_custom_event(stream, *obj.params_packet_script_custom_event); EXPECT_OR_BAIL(len_163); len += len_163; /*params_packet_script_custom_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SpawnParticleEffect: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_spawn_particle_effect); size_t len_164 = pdef::proto::size::packet_spawn_particle_effect(stream, *obj.params_packet_spawn_particle_effect); EXPECT_OR_BAIL(len_164); len += len_164; /*params_packet_spawn_particle_effect*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AvailableEntityIdentifiers: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_available_entity_identifiers); size_t len_165 = pdef::proto::size::packet_available_entity_identifiers(stream, *obj.params_packet_available_entity_identifiers); EXPECT_OR_BAIL(len_165); len += len_165; /*params_packet_available_entity_identifiers*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LevelSoundEventV2: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_level_sound_event_v2); size_t len_166 = pdef::proto::size::packet_level_sound_event_v2(stream, *obj.params_packet_level_sound_event_v2); EXPECT_OR_BAIL(len_166); len += len_166; /*params_packet_level_sound_event_v2*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::NetworkChunkPublisherUpdate: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_network_chunk_publisher_update); size_t len_167 = pdef::proto::size::packet_network_chunk_publisher_update(stream, *obj.params_packet_network_chunk_publisher_update); EXPECT_OR_BAIL(len_167); len += len_167; /*params_packet_network_chunk_publisher_update*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::BiomeDefinitionList: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_biome_definition_list); size_t len_168 = pdef::proto::size::packet_biome_definition_list(stream, *obj.params_packet_biome_definition_list); EXPECT_OR_BAIL(len_168); len += len_168; /*params_packet_biome_definition_list*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LevelSoundEvent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_level_sound_event); size_t len_169 = pdef::proto::size::packet_level_sound_event(stream, *obj.params_packet_level_sound_event); EXPECT_OR_BAIL(len_169); len += len_169; /*params_packet_level_sound_event*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LevelEventGeneric: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_level_event_generic); size_t len_170 = pdef::proto::size::packet_level_event_generic(stream, *obj.params_packet_level_event_generic); EXPECT_OR_BAIL(len_170); len += len_170; /*params_packet_level_event_generic*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LecternUpdate: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_lectern_update); size_t len_171 = pdef::proto::size::packet_lectern_update(stream, *obj.params_packet_lectern_update); EXPECT_OR_BAIL(len_171); len += len_171; /*params_packet_lectern_update*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::VideoStreamConnect: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_video_stream_connect); size_t len_172 = pdef::proto::size::packet_video_stream_connect(stream, *obj.params_packet_video_stream_connect); EXPECT_OR_BAIL(len_172); len += len_172; /*params_packet_video_stream_connect*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AddEcsEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_add_ecs_entity); size_t len_173 = pdef::proto::size::packet_add_ecs_entity(stream, *obj.params_packet_add_ecs_entity); EXPECT_OR_BAIL(len_173); len += len_173; /*params_packet_add_ecs_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::RemoveEcsEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_remove_ecs_entity); size_t len_174 = pdef::proto::size::packet_remove_ecs_entity(stream, *obj.params_packet_remove_ecs_entity); EXPECT_OR_BAIL(len_174); len += len_174; /*params_packet_remove_ecs_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ClientCacheStatus: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_client_cache_status); size_t len_175 = pdef::proto::size::packet_client_cache_status(stream, *obj.params_packet_client_cache_status); EXPECT_OR_BAIL(len_175); len += len_175; /*params_packet_client_cache_status*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::OnScreenTextureAnimation: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_on_screen_texture_animation); size_t len_176 = pdef::proto::size::packet_on_screen_texture_animation(stream, *obj.params_packet_on_screen_texture_animation); EXPECT_OR_BAIL(len_176); len += len_176; /*params_packet_on_screen_texture_animation*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MapCreateLockedCopy: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_map_create_locked_copy); size_t len_177 = pdef::proto::size::packet_map_create_locked_copy(stream, *obj.params_packet_map_create_locked_copy); EXPECT_OR_BAIL(len_177); len += len_177; /*params_packet_map_create_locked_copy*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::StructureTemplateDataExportRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_structure_template_data_export_request); size_t len_178 = pdef::proto::size::packet_structure_template_data_export_request(stream, *obj.params_packet_structure_template_data_export_request); EXPECT_OR_BAIL(len_178); len += len_178; /*params_packet_structure_template_data_export_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::StructureTemplateDataExportResponse: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_structure_template_data_export_response); size_t len_179 = pdef::proto::size::packet_structure_template_data_export_response(stream, *obj.params_packet_structure_template_data_export_response); EXPECT_OR_BAIL(len_179); len += len_179; /*params_packet_structure_template_data_export_response*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdateBlockProperties: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_block_properties); size_t len_180 = pdef::proto::size::packet_update_block_properties(stream, *obj.params_packet_update_block_properties); EXPECT_OR_BAIL(len_180); len += len_180; /*params_packet_update_block_properties*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ClientCacheBlobStatus: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_client_cache_blob_status); size_t len_181 = pdef::proto::size::packet_client_cache_blob_status(stream, *obj.params_packet_client_cache_blob_status); EXPECT_OR_BAIL(len_181); len += len_181; /*params_packet_client_cache_blob_status*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ClientCacheMissResponse: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_client_cache_miss_response); size_t len_182 = pdef::proto::size::packet_client_cache_miss_response(stream, *obj.params_packet_client_cache_miss_response); EXPECT_OR_BAIL(len_182); len += len_182; /*params_packet_client_cache_miss_response*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::EducationSettings: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_education_settings); size_t len_183 = pdef::proto::size::packet_education_settings(stream, *obj.params_packet_education_settings); EXPECT_OR_BAIL(len_183); len += len_183; /*params_packet_education_settings*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Emote: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_emote); size_t len_184 = pdef::proto::size::packet_emote(stream, *obj.params_packet_emote); EXPECT_OR_BAIL(len_184); len += len_184; /*params_packet_emote*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MultiplayerSettings: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_multiplayer_settings); size_t len_185 = pdef::proto::size::packet_multiplayer_settings(stream, *obj.params_packet_multiplayer_settings); EXPECT_OR_BAIL(len_185); len += len_185; /*params_packet_multiplayer_settings*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SettingsCommand: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_settings_command); size_t len_186 = pdef::proto::size::packet_settings_command(stream, *obj.params_packet_settings_command); EXPECT_OR_BAIL(len_186); len += len_186; /*params_packet_settings_command*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AnvilDamage: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_anvil_damage); size_t len_187 = pdef::proto::size::packet_anvil_damage(stream, *obj.params_packet_anvil_damage); EXPECT_OR_BAIL(len_187); len += len_187; /*params_packet_anvil_damage*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CompletedUsingItem: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_completed_using_item); size_t len_188 = pdef::proto::size::packet_completed_using_item(stream, *obj.params_packet_completed_using_item); EXPECT_OR_BAIL(len_188); len += len_188; /*params_packet_completed_using_item*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::NetworkSettings: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_network_settings); size_t len_189 = pdef::proto::size::packet_network_settings(stream, *obj.params_packet_network_settings); EXPECT_OR_BAIL(len_189); len += len_189; /*params_packet_network_settings*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerAuthInput: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_auth_input); size_t len_190 = pdef::proto::size::packet_player_auth_input(stream, *obj.params_packet_player_auth_input); EXPECT_OR_BAIL(len_190); len += len_190; /*params_packet_player_auth_input*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CreativeContent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_creative_content); size_t len_191 = pdef::proto::size::packet_creative_content(stream, *obj.params_packet_creative_content); EXPECT_OR_BAIL(len_191); len += len_191; /*params_packet_creative_content*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerEnchantOptions: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_enchant_options); size_t len_192 = pdef::proto::size::packet_player_enchant_options(stream, *obj.params_packet_player_enchant_options); EXPECT_OR_BAIL(len_192); len += len_192; /*params_packet_player_enchant_options*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ItemStackRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_item_stack_request); size_t len_193 = pdef::proto::size::packet_item_stack_request(stream, *obj.params_packet_item_stack_request); EXPECT_OR_BAIL(len_193); len += len_193; /*params_packet_item_stack_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ItemStackResponse: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_item_stack_response); size_t len_194 = pdef::proto::size::packet_item_stack_response(stream, *obj.params_packet_item_stack_response); EXPECT_OR_BAIL(len_194); len += len_194; /*params_packet_item_stack_response*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerArmorDamage: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_armor_damage); size_t len_195 = pdef::proto::size::packet_player_armor_damage(stream, *obj.params_packet_player_armor_damage); EXPECT_OR_BAIL(len_195); len += len_195; /*params_packet_player_armor_damage*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdatePlayerGameType: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_player_game_type); size_t len_196 = pdef::proto::size::packet_update_player_game_type(stream, *obj.params_packet_update_player_game_type); EXPECT_OR_BAIL(len_196); len += len_196; /*params_packet_update_player_game_type*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::EmoteList: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_emote_list); size_t len_197 = pdef::proto::size::packet_emote_list(stream, *obj.params_packet_emote_list); EXPECT_OR_BAIL(len_197); len += len_197; /*params_packet_emote_list*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PositionTrackingDbRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_position_tracking_db_request); size_t len_198 = pdef::proto::size::packet_position_tracking_db_request(stream, *obj.params_packet_position_tracking_db_request); EXPECT_OR_BAIL(len_198); len += len_198; /*params_packet_position_tracking_db_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PositionTrackingDbBroadcast: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_position_tracking_db_broadcast); size_t len_199 = pdef::proto::size::packet_position_tracking_db_broadcast(stream, *obj.params_packet_position_tracking_db_broadcast); EXPECT_OR_BAIL(len_199); len += len_199; /*params_packet_position_tracking_db_broadcast*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PacketViolationWarning: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_packet_violation_warning); size_t len_200 = pdef::proto::size::packet_packet_violation_warning(stream, *obj.params_packet_packet_violation_warning); EXPECT_OR_BAIL(len_200); len += len_200; /*params_packet_packet_violation_warning*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::MotionPredictionHints: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_motion_prediction_hints); size_t len_201 = pdef::proto::size::packet_motion_prediction_hints(stream, *obj.params_packet_motion_prediction_hints); EXPECT_OR_BAIL(len_201); len += len_201; /*params_packet_motion_prediction_hints*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AnimateEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_animate_entity); size_t len_202 = pdef::proto::size::packet_animate_entity(stream, *obj.params_packet_animate_entity); EXPECT_OR_BAIL(len_202); len += len_202; /*params_packet_animate_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CameraShake: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_camera_shake); size_t len_203 = pdef::proto::size::packet_camera_shake(stream, *obj.params_packet_camera_shake); EXPECT_OR_BAIL(len_203); len += len_203; /*params_packet_camera_shake*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PlayerFog: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_player_fog); size_t len_204 = pdef::proto::size::packet_player_fog(stream, *obj.params_packet_player_fog); EXPECT_OR_BAIL(len_204); len += len_204; /*params_packet_player_fog*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CorrectPlayerMovePrediction: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_correct_player_move_prediction); size_t len_205 = pdef::proto::size::packet_correct_player_move_prediction(stream, *obj.params_packet_correct_player_move_prediction); EXPECT_OR_BAIL(len_205); len += len_205; /*params_packet_correct_player_move_prediction*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ItemComponent: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_item_component); size_t len_206 = pdef::proto::size::packet_item_component(stream, *obj.params_packet_item_component); EXPECT_OR_BAIL(len_206); len += len_206; /*params_packet_item_component*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::FilterTextPacket: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_filter_text_packet); size_t len_207 = pdef::proto::size::packet_filter_text_packet(stream, *obj.params_packet_filter_text_packet); EXPECT_OR_BAIL(len_207); len += len_207; /*params_packet_filter_text_packet*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::DebugRenderer: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_debug_renderer); size_t len_208 = pdef::proto::size::packet_debug_renderer(stream, *obj.params_packet_debug_renderer); EXPECT_OR_BAIL(len_208); len += len_208; /*params_packet_debug_renderer*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SyncEntityProperty: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_sync_entity_property); size_t len_209 = pdef::proto::size::packet_sync_entity_property(stream, *obj.params_packet_sync_entity_property); EXPECT_OR_BAIL(len_209); len += len_209; /*params_packet_sync_entity_property*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AddVolumeEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_add_volume_entity); size_t len_210 = pdef::proto::size::packet_add_volume_entity(stream, *obj.params_packet_add_volume_entity); EXPECT_OR_BAIL(len_210); len += len_210; /*params_packet_add_volume_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::RemoveVolumeEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_remove_volume_entity); size_t len_211 = pdef::proto::size::packet_remove_volume_entity(stream, *obj.params_packet_remove_volume_entity); EXPECT_OR_BAIL(len_211); len += len_211; /*params_packet_remove_volume_entity*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SimulationType: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_simulation_type); size_t len_212 = pdef::proto::size::packet_simulation_type(stream, *obj.params_packet_simulation_type); EXPECT_OR_BAIL(len_212); len += len_212; /*params_packet_simulation_type*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::NpcDialogue: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_npc_dialogue); size_t len_213 = pdef::proto::size::packet_npc_dialogue(stream, *obj.params_packet_npc_dialogue); EXPECT_OR_BAIL(len_213); len += len_213; /*params_packet_npc_dialogue*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::EduUriResourcePacket: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_edu_uri_resource_packet); size_t len_214 = pdef::proto::size::packet_edu_uri_resource_packet(stream, *obj.params_packet_edu_uri_resource_packet); EXPECT_OR_BAIL(len_214); len += len_214; /*params_packet_edu_uri_resource_packet*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CreatePhoto: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_create_photo); size_t len_215 = pdef::proto::size::packet_create_photo(stream, *obj.params_packet_create_photo); EXPECT_OR_BAIL(len_215); len += len_215; /*params_packet_create_photo*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::UpdateSubchunkBlocks: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_update_subchunk_blocks); size_t len_216 = pdef::proto::size::packet_update_subchunk_blocks(stream, *obj.params_packet_update_subchunk_blocks); EXPECT_OR_BAIL(len_216); len += len_216; /*params_packet_update_subchunk_blocks*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::PhotoInfoRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_photo_info_request); size_t len_217 = pdef::proto::size::packet_photo_info_request(stream, *obj.params_packet_photo_info_request); EXPECT_OR_BAIL(len_217); len += len_217; /*params_packet_photo_info_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::Subchunk: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_subchunk); size_t len_218 = pdef::proto::size::packet_subchunk(stream, *obj.params_packet_subchunk); EXPECT_OR_BAIL(len_218); len += len_218; /*params_packet_subchunk*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::SubchunkRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_subchunk_request); size_t len_219 = pdef::proto::size::packet_subchunk_request(stream, *obj.params_packet_subchunk_request); EXPECT_OR_BAIL(len_219); len += len_219; /*params_packet_subchunk_request*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ClientStartItemCooldown: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_client_start_item_cooldown); size_t len_220 = pdef::proto::size::packet_client_start_item_cooldown(stream, *obj.params_packet_client_start_item_cooldown); EXPECT_OR_BAIL(len_220); len += len_220; /*params_packet_client_start_item_cooldown*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ScriptMessage: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_script_message); size_t len_221 = pdef::proto::size::packet_script_message(stream, *obj.params_packet_script_message); EXPECT_OR_BAIL(len_221); len += len_221; /*params_packet_script_message*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::CodeBuilderSource: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_code_builder_source); size_t len_222 = pdef::proto::size::packet_code_builder_source(stream, *obj.params_packet_code_builder_source); EXPECT_OR_BAIL(len_222); len += len_222; /*params_packet_code_builder_source*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::TickingAreasLoadStatus: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_ticking_areas_load_status); size_t len_223 = pdef::proto::size::packet_ticking_areas_load_status(stream, *obj.params_packet_ticking_areas_load_status); EXPECT_OR_BAIL(len_223); len += len_223; /*params_packet_ticking_areas_load_status*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::DimensionData: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_dimension_data); size_t len_224 = pdef::proto::size::packet_dimension_data(stream, *obj.params_packet_dimension_data); EXPECT_OR_BAIL(len_224); len += len_224; /*params_packet_dimension_data*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::AgentAction: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_agent_action); size_t len_225 = pdef::proto::size::packet_agent_action(stream, *obj.params_packet_agent_action); EXPECT_OR_BAIL(len_225); len += len_225; /*params_packet_agent_action*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ChangeMobProperty: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_change_mob_property); size_t len_226 = pdef::proto::size::packet_change_mob_property(stream, *obj.params_packet_change_mob_property); EXPECT_OR_BAIL(len_226); len += len_226; /*params_packet_change_mob_property*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::LessonProgress: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_lesson_progress); size_t len_227 = pdef::proto::size::packet_lesson_progress(stream, *obj.params_packet_lesson_progress); EXPECT_OR_BAIL(len_227); len += len_227; /*params_packet_lesson_progress*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::RequestAbility: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_request_ability); size_t len_228 = pdef::proto::size::packet_request_ability(stream, *obj.params_packet_request_ability); EXPECT_OR_BAIL(len_228); len += len_228; /*params_packet_request_ability*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::RequestPermissions: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_request_permissions); size_t len_229 = pdef::proto::size::packet_request_permissions(stream, *obj.params_packet_request_permissions); EXPECT_OR_BAIL(len_229); len += len_229; /*params_packet_request_permissions*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::mcpe_packet::Name::ToastRequest: { /*8.5*/
        EXPECT_OR_BAIL(obj.params_packet_toast_request); size_t len_230 = pdef::proto::size::packet_toast_request(stream, *obj.params_packet_toast_request); EXPECT_OR_BAIL(len_230); len += len_230; /*params_packet_toast_request*/ /*4.4*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
  ...
  size_t packet_resource_packs_info(pdef::Stream &stream, const pdef::proto::packet_resource_packs_info &obj) {
    ...
    len += 1; /*0.2*/
    len += 2; /*2.4*/
    for (const auto &v : obj.behaviour_packs) { size_t len_231 = pdef::proto::size::BehaviourPackInfos(stream, v); EXPECT_OR_BAIL(len_231); len += len_231; } /*2.5*/
    len += 2; /*2.4*/
    for (const auto &v : obj.texture_packs) { size_t len_232 = pdef::proto::size::TexturePackInfos(stream, v); EXPECT_OR_BAIL(len_232); len += len_232; } /*2.5*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_resource_pack_stack(pdef::Stream &stream, const pdef::proto::packet_resource_pack_stack &obj) {
    size_t len = 0;
    ...
    for (const auto &v : obj.behavior_packs) { size_t len_233 = pdef::proto::size::ResourcePackIdVersions(stream, v); EXPECT_OR_BAIL(len_233); len += len_233; } /*2.5*/
    len += stream.sizeOfVarInt(obj.resource_packs.size()); /*2.4*/
    for (const auto &v : obj.resource_packs) { size_t len_234 = pdef::proto::size::ResourcePackIdVersions(stream, v); EXPECT_OR_BAIL(len_234); len += len_234; } /*2.5*/
    ...
    for (const auto &v2 : obj.experiments) {
      size_t len_235 = pdef::proto::size::Experiment(stream, v2); EXPECT_OR_BAIL(len_235); len += len_235; /**/ /*4.4*/
    }
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  ...
  size_t packet_start_game(pdef::Stream &stream, const pdef::proto::packet_start_game &obj) {
    ...
    size_t len_236 = pdef::proto::size::vec3f(stream, obj.player_position); EXPECT_OR_BAIL(len_236); len += len_236; /*player_position*/ /*4.4*/
    size_t len_237 = pdef::proto::size::vec2f(stream, obj.rotation); EXPECT_OR_BAIL(len_237); len += len_237; /*rotation*/ /*4.4*/
    len += 8; /*0.2*/
    len += 2; /*0.2*/
    ...
    size_t len_238 = pdef::proto::size::BlockCoordinates(stream, obj.spawn_position); EXPECT_OR_BAIL(len_238); len += len_238; /*spawn_position*/ /*4.4*/
    len += 1; /*0.2*/
    ...
    for (const auto &v2 : obj.gamerules) {
      size_t len_239 = pdef::proto::size::GameRule(stream, v2); EXPECT_OR_BAIL(len_239); len += len_239; /**/ /*4.4*/
    }
    len += 4; /*1.3*/
    for (const auto &v2 : obj.experiments) {
      size_t len_240 = pdef::proto::size::Experiment(stream, v2); EXPECT_OR_BAIL(len_240); len += len_240; /**/ /*4.4*/
    }
    len += 1; /*0.2*/
    len += 1; /*0.2*/
    len += 1; /*0.2*/
    ...
    len += 4; /*0.2*/
    len += 1; /*0.2*/
    size_t len_241 = pdef::proto::size::EducationSharedResourceURI(stream, obj.edu_resource_uri); EXPECT_OR_BAIL(len_241); len += len_241; /*edu_resource_uri*/ /*4.4*/
    len += 1; /*0.2*/
    ...
    for (const auto &v : obj.block_properties) { size_t len_242 = pdef::proto::size::BlockProperties(stream, v); EXPECT_OR_BAIL(len_242); len += len_242; } /*2.5*/
    len += stream.sizeOfVarInt(obj.itemstates.size()); /*2.4*/
    for (const auto &v : obj.itemstates) { size_t len_243 = pdef::proto::size::Itemstates(stream, v); EXPECT_OR_BAIL(len_243); len += len_243; } /*2.5*/
  ...
  size_t packet_add_player(pdef::Stream &stream, const pdef::proto::packet_add_player &obj) {
    ...
    len += stream.sizeOfVarInt(obj.platform_chat_id.length());
    len += obj.platform_chat_id.length(); /*platform_chat_id: pstring*/ /*4.1*/
    size_t len_244 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_244); len += len_244; /*position*/ /*4.4*/
    size_t len_245 = pdef::proto::size::vec3f(stream, obj.velocity); EXPECT_OR_BAIL(len_245); len += len_245; /*velocity*/ /*4.4*/
    len += 4; /*0.2*/
    len += 4; /*0.2*/
    len += 4; /*0.2*/
    size_t len_246 = pdef::proto::size::Item(stream, obj.held_item); EXPECT_OR_BAIL(len_246); len += len_246; /*held_item*/ /*4.4*/
    len += stream.sizeOfZigZagVarInt((int&)obj.gamemode); /*gamemode: zigzag32*/ /*7.0*/
    len += stream.sizeOfVarInt(obj.metadata.size()); /*2.4*/
    for (const auto &v : obj.metadata) { size_t len_247 = pdef::proto::size::MetadataDictionary(stream, v); EXPECT_OR_BAIL(len_247); len += len_247; } /*2.5*/
    len += stream.sizeOfVarInt(obj.flags); /*0.2*/
    ...
    for (const auto &v2 : obj.links) {
      size_t len_248 = pdef::proto::size::Link(stream, v2); EXPECT_OR_BAIL(len_248); len += len_248; /**/ /*4.4*/
    }
  ...
  size_t packet_add_entity(pdef::Stream &stream, const pdef::proto::packet_add_entity &obj) {
    ...
    size_t len_249 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_249); len += len_249; /*position*/ /*4.4*/
    size_t len_250 = pdef::proto::size::vec3f(stream, obj.velocity); EXPECT_OR_BAIL(len_250); len += len_250; /*velocity*/ /*4.4*/
    len += 4; /*0.2*/
    len += 4; /*0.2*/
    len += 4; /*0.2*/
    len += stream.sizeOfVarInt(obj.attributes.size()); /*2.4*/
    for (const auto &v : obj.attributes) { size_t len_251 = pdef::proto::size::EntityAttributes(stream, v); EXPECT_OR_BAIL(len_251); len += len_251; } /*2.5*/
    len += stream.sizeOfVarInt(obj.metadata.size()); /*2.4*/
    for (const auto &v : obj.metadata) { size_t len_252 = pdef::proto::size::MetadataDictionary(stream, v); EXPECT_OR_BAIL(len_252); len += len_252; } /*2.5*/
    len += stream.sizeOfVarInt(obj.links.size()); /*1.3*/
    for (const auto &v2 : obj.links) {
      size_t len_253 = pdef::proto::size::Link(stream, v2); EXPECT_OR_BAIL(len_253); len += len_253; /**/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_remove_entity(pdef::Stream &stream, const pdef::proto::packet_remove_entity &obj) {
  ...
  size_t packet_add_item_entity(pdef::Stream &stream, const pdef::proto::packet_add_item_entity &obj) {
    ...
    len += stream.sizeOfZigZagVarLong(obj.entity_id_self); /*0.2*/
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    size_t len_254 = pdef::proto::size::Item(stream, obj.item); EXPECT_OR_BAIL(len_254); len += len_254; /*item*/ /*4.4*/
    size_t len_255 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_255); len += len_255; /*position*/ /*4.4*/
    size_t len_256 = pdef::proto::size::vec3f(stream, obj.velocity); EXPECT_OR_BAIL(len_256); len += len_256; /*velocity*/ /*4.4*/
    len += stream.sizeOfVarInt(obj.metadata.size()); /*2.4*/
    for (const auto &v : obj.metadata) { size_t len_257 = pdef::proto::size::MetadataDictionary(stream, v); EXPECT_OR_BAIL(len_257); len += len_257; } /*2.5*/
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_take_item_entity(pdef::Stream &stream, const pdef::proto::packet_take_item_entity &obj) {
  ...
  size_t packet_move_entity(pdef::Stream &stream, const pdef::proto::packet_move_entity &obj) {
    ...
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    len += 1; /*0.2*/
    size_t len_258 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_258); len += len_258; /*position*/ /*4.4*/
    size_t len_259 = pdef::proto::size::Rotation(stream, obj.rotation); EXPECT_OR_BAIL(len_259); len += len_259; /*rotation*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_move_player(pdef::Stream &stream, const pdef::proto::packet_move_player &obj) {
    size_t len = 0;
    len += stream.sizeOfVarInt(obj.runtime_id); /*0.2*/
    size_t len_260 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_260); len += len_260; /*position*/ /*4.4*/
    len += 4; /*0.2*/
    len += 4; /*0.2*/
    len += 4; /*0.2*/
  ...
  size_t packet_update_block(pdef::Stream &stream, const pdef::proto::packet_update_block &obj) {
    size_t len = 0;
    size_t len_261 = pdef::proto::size::BlockCoordinates(stream, obj.position); EXPECT_OR_BAIL(len_261); len += len_261; /*position*/ /*4.4*/
    len += stream.sizeOfVarInt(obj.block_runtime_id); /*0.2*/
    int flags_val = 0; /*X*/
  ...
  size_t packet_add_painting(pdef::Stream &stream, const pdef::proto::packet_add_painting &obj) {
    ...
    len += stream.sizeOfZigZagVarLong(obj.entity_id_self); /*0.2*/
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    size_t len_262 = pdef::proto::size::vec3f(stream, obj.coordinates); EXPECT_OR_BAIL(len_262); len += len_262; /*coordinates*/ /*4.4*/
  ...
  size_t packet_level_sound_event_old(pdef::Stream &stream, const pdef::proto::packet_level_sound_event_old &obj) {
    size_t len = 0;
    len += 1; /*0.2*/
    size_t len_263 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_263); len += len_263; /*position*/ /*4.4*/
  ...
  size_t packet_level_event(pdef::Stream &stream, const pdef::proto::packet_level_event &obj) {
    ...
    size_t len_264 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_264); len += len_264; /*position*/ /*4.4*/
    len += stream.sizeOfZigZagVarInt(obj.data); /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_block_event(pdef::Stream &stream, const pdef::proto::packet_block_event &obj) {
    size_t len = 0;
    size_t len_265 = pdef::proto::size::BlockCoordinates(stream, obj.position); EXPECT_OR_BAIL(len_265); len += len_265; /*position*/ /*4.4*/
    len += stream.sizeOfZigZagVarInt((int&)obj.type); /*type: zigzag32*/ /*7.0*/
    len += stream.sizeOfZigZagVarInt(obj.data); /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  ...
  size_t packet_update_attributes(pdef::Stream &stream, const pdef::proto::packet_update_attributes &obj) {
    ...
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    len += stream.sizeOfVarInt(obj.attributes.size()); /*2.4*/
    for (const auto &v : obj.attributes) { size_t len_266 = pdef::proto::size::PlayerAttributes(stream, v); EXPECT_OR_BAIL(len_266); len += len_266; } /*2.5*/
    len += stream.sizeOfVarInt64(obj.tick); /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_inventory_transaction(pdef::Stream &stream, const pdef::proto::packet_inventory_transaction &obj) {
    size_t len = 0;
    size_t len_267 = pdef::proto::size::Transaction(stream, obj.transaction); EXPECT_OR_BAIL(len_267); len += len_267; /*transaction*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_mob_equipment(pdef::Stream &stream, const pdef::proto::packet_mob_equipment &obj) {
    size_t len = 0;
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    size_t len_268 = pdef::proto::size::Item(stream, obj.item); EXPECT_OR_BAIL(len_268); len += len_268; /*item*/ /*4.4*/
    len += 1; /*0.2*/
    len += 1; /*0.2*/
  ...
  size_t packet_mob_armor_equipment(pdef::Stream &stream, const pdef::proto::packet_mob_armor_equipment &obj) {
    size_t len = 0;
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    size_t len_269 = pdef::proto::size::Item(stream, obj.helmet); EXPECT_OR_BAIL(len_269); len += len_269; /*helmet*/ /*4.4*/
    size_t len_270 = pdef::proto::size::Item(stream, obj.chestplate); EXPECT_OR_BAIL(len_270); len += len_270; /*chestplate*/ /*4.4*/
    size_t len_271 = pdef::proto::size::Item(stream, obj.leggings); EXPECT_OR_BAIL(len_271); len += len_271; /*leggings*/ /*4.4*/
    size_t len_272 = pdef::proto::size::Item(stream, obj.boots); EXPECT_OR_BAIL(len_272); len += len_272; /*boots*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_interact(pdef::Stream &stream, const pdef::proto::packet_interact &obj) {
    size_t len = 0;
    ...
    switch (action_id) { /*8.0*/
      case pdef::proto::packet_interact::ActionId::MouseOverEntity: { /*8.5*/
        EXPECT_OR_BAIL(obj.position); size_t len_273 = pdef::proto::size::vec3f(stream, *obj.position); EXPECT_OR_BAIL(len_273); len += len_273; /*position*/ /*4.4*/
        break;
      } /*8.7*/
      case pdef::proto::packet_interact::ActionId::LeaveVehicle: { /*8.5*/
        EXPECT_OR_BAIL(obj.position); size_t len_274 = pdef::proto::size::vec3f(stream, *obj.position); EXPECT_OR_BAIL(len_274); len += len_274; /*position*/ /*4.4*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
  ...
  size_t packet_player_action(pdef::Stream &stream, const pdef::proto::packet_player_action &obj) {
    ...
    size_t len_275 = pdef::proto::size::BlockCoordinates(stream, obj.position); EXPECT_OR_BAIL(len_275); len += len_275; /*position*/ /*4.4*/
    size_t len_276 = pdef::proto::size::BlockCoordinates(stream, obj.result_position); EXPECT_OR_BAIL(len_276); len += len_276; /*result_position*/ /*4.4*/
    len += stream.sizeOfZigZagVarInt(obj.face); /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_hurt_armor(pdef::Stream &stream, const pdef::proto::packet_hurt_armor &obj) {
  ...
  size_t packet_set_entity_data(pdef::Stream &stream, const pdef::proto::packet_set_entity_data &obj) {
    ...
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    len += stream.sizeOfVarInt(obj.metadata.size()); /*2.4*/
    for (const auto &v : obj.metadata) { size_t len_277 = pdef::proto::size::MetadataDictionary(stream, v); EXPECT_OR_BAIL(len_277); len += len_277; } /*2.5*/
    len += stream.sizeOfVarInt64(obj.tick); /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_set_entity_motion(pdef::Stream &stream, const pdef::proto::packet_set_entity_motion &obj) {
    size_t len = 0;
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    size_t len_278 = pdef::proto::size::vec3f(stream, obj.velocity); EXPECT_OR_BAIL(len_278); len += len_278; /*velocity*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_set_entity_link(pdef::Stream &stream, const pdef::proto::packet_set_entity_link &obj) {
    size_t len = 0;
    size_t len_279 = pdef::proto::size::Link(stream, obj.link); EXPECT_OR_BAIL(len_279); len += len_279; /*link*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_set_health(pdef::Stream &stream, const pdef::proto::packet_set_health &obj) {
    size_t len = 0;
  ...
  size_t packet_set_spawn_position(pdef::Stream &stream, const pdef::proto::packet_set_spawn_position &obj) {
    ...
    size_t len_280 = pdef::proto::size::BlockCoordinates(stream, obj.player_position); EXPECT_OR_BAIL(len_280); len += len_280; /*player_position*/ /*4.4*/
    len += stream.sizeOfZigZagVarInt(obj.dimension); /*0.2*/
    size_t len_281 = pdef::proto::size::BlockCoordinates(stream, obj.world_position); EXPECT_OR_BAIL(len_281); len += len_281; /*world_position*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_animate(pdef::Stream &stream, const pdef::proto::packet_animate &obj) {
    size_t len = 0;
  ...
  size_t packet_respawn(pdef::Stream &stream, const pdef::proto::packet_respawn &obj) {
    size_t len = 0;
    size_t len_282 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_282); len += len_282; /*position*/ /*4.4*/
    len += 1; /*0.2*/
    len += stream.sizeOfVarInt64(obj.runtime_entity_id); /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_container_open(pdef::Stream &stream, const pdef::proto::packet_container_open &obj) {
    ...
    size_t len_283 = pdef::proto::size::BlockCoordinates(stream, obj.coordinates); EXPECT_OR_BAIL(len_283); len += len_283; /*coordinates*/ /*4.4*/
  ...
  size_t packet_inventory_content(pdef::Stream &stream, const pdef::proto::packet_inventory_content &obj) {
    ...
    for (const auto &v2 : obj.input) {
      size_t len_284 = pdef::proto::size::Item(stream, v2); EXPECT_OR_BAIL(len_284); len += len_284; /**/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_inventory_slot(pdef::Stream &stream, const pdef::proto::packet_inventory_slot &obj) {
    ...
    len += stream.sizeOfVarInt((int&)obj.window_id); /*window_id: varint*/ /*7.0*/
    len += stream.sizeOfVarInt(obj.slot); /*0.2*/
    size_t len_285 = pdef::proto::size::Item(stream, obj.item); EXPECT_OR_BAIL(len_285); len += len_285; /*item*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_container_set_data(pdef::Stream &stream, const pdef::proto::packet_container_set_data &obj) {
    size_t len = 0;
  ...
  size_t packet_crafting_data(pdef::Stream &stream, const pdef::proto::packet_crafting_data &obj) {
    ...
    for (const auto &v : obj.recipes) { size_t len_286 = pdef::proto::size::Recipes(stream, v); EXPECT_OR_BAIL(len_286); len += len_286; } /*2.5*/
    len += stream.sizeOfVarInt(obj.potion_type_recipes.size()); /*2.4*/
    for (const auto &v : obj.potion_type_recipes) { size_t len_287 = pdef::proto::size::PotionTypeRecipes(stream, v); EXPECT_OR_BAIL(len_287); len += len_287; } /*2.5*/
    len += stream.sizeOfVarInt(obj.potion_container_recipes.size()); /*2.4*/
    for (const auto &v : obj.potion_container_recipes) { size_t len_288 = pdef::proto::size::PotionContainerChangeRecipes(stream, v); EXPECT_OR_BAIL(len_288); len += len_288; } /*2.5*/
    len += stream.sizeOfVarInt(obj.material_reducers.size()); /*1.3*/
    for (const auto &v2 : obj.material_reducers) {
      size_t len_289 = pdef::proto::size::MaterialReducer(stream, v2); EXPECT_OR_BAIL(len_289); len += len_289; /**/ /*4.4*/
    }
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_crafting_event(pdef::Stream &stream, const pdef::proto::packet_crafting_event &obj) {
    ...
    len += stream.sizeOfVarInt(obj.input.size()); /*1.3*/
    for (const auto &v2 : obj.input) {
      size_t len_290 = pdef::proto::size::Item(stream, v2); EXPECT_OR_BAIL(len_290); len += len_290; /**/ /*4.4*/
    }
    len += stream.sizeOfVarInt(obj.result.size()); /*1.3*/
    for (const auto &v2 : obj.result) {
      size_t len_291 = pdef::proto::size::Item(stream, v2); EXPECT_OR_BAIL(len_291); len += len_291; /**/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_gui_data_pick_item(pdef::Stream &stream, const pdef::proto::packet_gui_data_pick_item &obj) {
  ...
  size_t packet_block_entity_data(pdef::Stream &stream, const pdef::proto::packet_block_entity_data &obj) {
    size_t len = 0;
    size_t len_292 = pdef::proto::size::BlockCoordinates(stream, obj.position); EXPECT_OR_BAIL(len_292); len += len_292; /*position*/ /*4.4*/
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_player_input(pdef::Stream &stream, const pdef::proto::packet_player_input &obj) {
  ...
  size_t packet_change_dimension(pdef::Stream &stream, const pdef::proto::packet_change_dimension &obj) {
    size_t len = 0;
    len += stream.sizeOfZigZagVarInt(obj.dimension); /*0.2*/
    size_t len_293 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_293); len += len_293; /*position*/ /*4.4*/
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_set_player_game_type(pdef::Stream &stream, const pdef::proto::packet_set_player_game_type &obj) {
  ...
  size_t packet_player_list(pdef::Stream &stream, const pdef::proto::packet_player_list &obj) {
    size_t len = 0;
    size_t len_294 = pdef::proto::size::PlayerRecords(stream, obj.records); EXPECT_OR_BAIL(len_294); len += len_294; /*records*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_simple_event(pdef::Stream &stream, const pdef::proto::packet_simple_event &obj) {
    size_t len = 0;
  ...
  size_t packet_spawn_experience_orb(pdef::Stream &stream, const pdef::proto::packet_spawn_experience_orb &obj) {
    size_t len = 0;
    size_t len_295 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_295); len += len_295; /*position*/ /*4.4*/
    len += stream.sizeOfZigZagVarInt(obj.count); /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_clientbound_map_item_data(pdef::Stream &stream, const pdef::proto::packet_clientbound_map_item_data &obj) {
    ...
    if (update_flags.decoration == true) { /*8.2*/
        ...
        for (const auto &v4 : v.objects) {
          size_t len_296 = pdef::proto::size::TrackedObject(stream, v4); EXPECT_OR_BAIL(len_296); len += len_296; /**/ /*4.4*/
        }
        len += stream.sizeOfVarInt(v.decorations.size()); /*1.3*/
        for (const auto &v4 : v.decorations) {
          size_t len_297 = pdef::proto::size::MapDecoration(stream, v4); EXPECT_OR_BAIL(len_297); len += len_297; /**/ /*4.4*/
        }
    }
  ...
  size_t packet_item_frame_drop_item(pdef::Stream &stream, const pdef::proto::packet_item_frame_drop_item &obj) {
    size_t len = 0;
    size_t len_298 = pdef::proto::size::BlockCoordinates(stream, obj.coordinates); EXPECT_OR_BAIL(len_298); len += len_298; /*coordinates*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_game_rules_changed(pdef::Stream &stream, const pdef::proto::packet_game_rules_changed &obj) {
    size_t len = 0;
    ...
    for (const auto &v2 : obj.rules) {
      size_t len_299 = pdef::proto::size::GameRule(stream, v2); EXPECT_OR_BAIL(len_299); len += len_299; /**/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_camera(pdef::Stream &stream, const pdef::proto::packet_camera &obj) {
  ...
  size_t packet_command_request(pdef::Stream &stream, const pdef::proto::packet_command_request &obj) {
    ...
    size_t len_300 = pdef::proto::size::CommandOrigin(stream, obj.origin); EXPECT_OR_BAIL(len_300); len += len_300; /*origin*/ /*4.4*/
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_command_block_update(pdef::Stream &stream, const pdef::proto::packet_command_block_update &obj) {
    ...
    if (is_block == true) { /*8.1*/
        EXPECT_OR_BAIL(obj.position); size_t len_301 = pdef::proto::size::BlockCoordinates(stream, *obj.position); EXPECT_OR_BAIL(len_301); len += len_301; /*position*/ /*4.4*/
  ...
  size_t packet_command_output(pdef::Stream &stream, const pdef::proto::packet_command_output &obj) {
    size_t len = 0;
    size_t len_302 = pdef::proto::size::CommandOrigin(stream, obj.origin); EXPECT_OR_BAIL(len_302); len += len_302; /*origin*/ /*4.4*/
  ...
  size_t packet_play_sound(pdef::Stream &stream, const pdef::proto::packet_play_sound &obj) {
    ...
    len += stream.sizeOfVarInt(obj.name.length());
    len += obj.name.length(); /*name: pstring*/ /*4.1*/
    size_t len_303 = pdef::proto::size::BlockCoordinates(stream, obj.coordinates); EXPECT_OR_BAIL(len_303); len += len_303; /*coordinates*/ /*4.4*/
    len += 4; /*0.2*/
    len += 4; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  ...
  size_t packet_structure_block_update(pdef::Stream &stream, const pdef::proto::packet_structure_block_update &obj) {
    size_t len = 0;
    size_t len_304 = pdef::proto::size::BlockCoordinates(stream, obj.position); EXPECT_OR_BAIL(len_304); len += len_304; /*position*/ /*4.4*/
    ...
    size_t len_305 = pdef::proto::size::StructureBlockSettings(stream, obj.settings); EXPECT_OR_BAIL(len_305); len += len_305; /*settings*/ /*4.4*/
  ...
  size_t packet_player_skin(pdef::Stream &stream, const pdef::proto::packet_player_skin &obj) {
    size_t len = 0;
    len += 8; /*0.2*/
    size_t len_306 = pdef::proto::size::Skin(stream, obj.skin); EXPECT_OR_BAIL(len_306); len += len_306; /*skin*/ /*4.4*/
  ...
  size_t packet_lab_table(pdef::Stream &stream, const pdef::proto::packet_lab_table &obj) {
    size_t len = 0;
    len += 1; /*action_type: u8*/ /*7.0*/
    size_t len_307 = pdef::proto::size::vec3i(stream, obj.position); EXPECT_OR_BAIL(len_307); len += len_307; /*position*/ /*4.4*/
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_update_block_synced(pdef::Stream &stream, const pdef::proto::packet_update_block_synced &obj) {
    size_t len = 0;
    size_t len_308 = pdef::proto::size::BlockCoordinates(stream, obj.position); EXPECT_OR_BAIL(len_308); len += len_308; /*position*/ /*4.4*/
    len += stream.sizeOfVarInt(obj.block_runtime_id); /*0.2*/
    int flags_val = 0; /*X*/
    if (obj.flags.neighbors) flags_val |= 1;
    if (obj.flags.network) flags_val |= 2;
  ...
  size_t packet_spawn_particle_effect(pdef::Stream &stream, const pdef::proto::packet_spawn_particle_effect &obj) {
    ...
    len += 1; /*0.2*/
    len += stream.sizeOfZigZagVarLong(obj.entity_id); /*0.2*/
    size_t len_309 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_309); len += len_309; /*position*/ /*4.4*/
  ...
  size_t packet_level_sound_event_v2(pdef::Stream &stream, const pdef::proto::packet_level_sound_event_v2 &obj) {
    size_t len = 0;
    len += 1; /*0.2*/
    size_t len_310 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_310); len += len_310; /*position*/ /*4.4*/
    len += stream.sizeOfZigZagVarInt(obj.block_id); /*0.2*/
    len += stream.sizeOfVarInt(obj.entity_type.length());
    len += obj.entity_type.length(); /*entity_type: pstring*/ /*4.1*/
    len += 1; /*0.2*/
  ...
  size_t packet_network_chunk_publisher_update(pdef::Stream &stream, const pdef::proto::packet_network_chunk_publisher_update &obj) {
    size_t len = 0;
    size_t len_311 = pdef::proto::size::BlockCoordinates(stream, obj.coordinates); EXPECT_OR_BAIL(len_311); len += len_311; /*coordinates*/ /*4.4*/
  ...
  size_t packet_level_sound_event(pdef::Stream &stream, const pdef::proto::packet_level_sound_event &obj) {
    ...
    size_t len_312 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_312); len += len_312; /*position*/ /*4.4*/
  ...
  size_t packet_lectern_update(pdef::Stream &stream, const pdef::proto::packet_lectern_update &obj) {
    ...
    len += 1; /*0.2*/
    len += 1; /*0.2*/
    size_t len_313 = pdef::proto::size::vec3i(stream, obj.position); EXPECT_OR_BAIL(len_313); len += len_313; /*position*/ /*4.4*/
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_video_stream_connect(pdef::Stream &stream, const pdef::proto::packet_video_stream_connect &obj) {
  ...
  size_t packet_structure_template_data_export_request(pdef::Stream &stream, const pdef::proto::packet_structure_template_data_export_request &obj) {
    ...
    len += stream.sizeOfVarInt(obj.name.length());
    len += obj.name.length(); /*name: pstring*/ /*4.1*/
    size_t len_314 = pdef::proto::size::BlockCoordinates(stream, obj.position); EXPECT_OR_BAIL(len_314); len += len_314; /*position*/ /*4.4*/
    size_t len_315 = pdef::proto::size::StructureBlockSettings(stream, obj.settings); EXPECT_OR_BAIL(len_315); len += len_315; /*settings*/ /*4.4*/
    len += 1; /*request_type: u8*/ /*7.0*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_structure_template_data_export_response(pdef::Stream &stream, const pdef::proto::packet_structure_template_data_export_response &obj) {
  ...
  size_t packet_client_cache_miss_response(pdef::Stream &stream, const pdef::proto::packet_client_cache_miss_response &obj) {
    ...
    for (const auto &v2 : obj.blobs) {
      size_t len_316 = pdef::proto::size::Blob(stream, v2); EXPECT_OR_BAIL(len_316); len += len_316; /**/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_education_settings(pdef::Stream &stream, const pdef::proto::packet_education_settings &obj) {
  ...
  size_t packet_anvil_damage(pdef::Stream &stream, const pdef::proto::packet_anvil_damage &obj) {
    size_t len = 0;
    len += 1; /*0.2*/
    size_t len_317 = pdef::proto::size::BlockCoordinates(stream, obj.position); EXPECT_OR_BAIL(len_317); len += len_317; /*position*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_completed_using_item(pdef::Stream &stream, const pdef::proto::packet_completed_using_item &obj) {
    size_t len = 0;
  ...
  size_t packet_player_auth_input(pdef::Stream &stream, const pdef::proto::packet_player_auth_input &obj) {
    ...
    len += 4; /*0.2*/
    len += 4; /*0.2*/
    size_t len_318 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_318); len += len_318; /*position*/ /*4.4*/
    size_t len_319 = pdef::proto::size::vec2f(stream, obj.move_vector); EXPECT_OR_BAIL(len_319); len += len_319; /*move_vector*/ /*4.4*/
    len += 4; /*0.2*/
    ...
    switch (play_mode) { /*8.0*/
      case pdef::proto::packet_player_auth_input::PlayMode::Reality: { /*8.5*/
        EXPECT_OR_BAIL(obj.gaze_direction); size_t len_320 = pdef::proto::size::vec3f(stream, *obj.gaze_direction); EXPECT_OR_BAIL(len_320); len += len_320; /*gaze_direction*/ /*4.4*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
    len += stream.sizeOfVarInt64(obj.tick); /*0.2*/
    size_t len_321 = pdef::proto::size::vec3f(stream, obj.delta); EXPECT_OR_BAIL(len_321); len += len_321; /*delta*/ /*4.4*/
    if (input_data.item_interact == true) { /*8.2*/
        ...
        size_t len_322 = pdef::proto::size::TransactionLegacy(stream, v.legacy); EXPECT_OR_BAIL(len_322); len += len_322; /*legacy*/ /*4.4*/
        len += stream.sizeOfVarInt(v.actions.size()); /*2.4*/
        for (const auto &v : v.actions) { size_t len_323 = pdef::proto::size::TransactionActions(stream, v); EXPECT_OR_BAIL(len_323); len += len_323; } /*2.5*/
        size_t len_324 = pdef::proto::size::TransactionUseItem(stream, v.data); EXPECT_OR_BAIL(len_324); len += len_324; /*data*/ /*4.4*/
    }
    if (input_data.item_stack_request == true) { /*8.2*/
      EXPECT_OR_BAIL(obj.item_stack_request); size_t len_325 = pdef::proto::size::ItemStackRequest(stream, *obj.item_stack_request); EXPECT_OR_BAIL(len_325); len += len_325; /*item_stack_request*/ /*4.4*/
    }
    if (input_data.block_action == true) { /*8.2*/
      ...
      for (const auto &v3 : obj.block_action) { /*5.20*/
        ...
        if (action == pdef::proto::packet_player_auth_input::BlockAction::Action::StartBreak) { /*8.5*/
            EXPECT_OR_BAIL(v3.position); size_t len_326 = pdef::proto::size::vec3i(stream, *v3.position); EXPECT_OR_BAIL(len_326); len += len_326; /*position*/ /*4.4*/
            ...
            EXPECT_OR_BAIL(v3.position); size_t len_327 = pdef::proto::size::vec3i(stream, *v3.position); EXPECT_OR_BAIL(len_327); len += len_327; /*position*/ /*4.4*/
            len += stream.sizeOfZigZagVarInt(v3.face); /*0.2*/
        }
        else if (action == pdef::proto::packet_player_auth_input::BlockAction::Action::CrackBreak) { /*8.5*/
            EXPECT_OR_BAIL(v3.position); size_t len_328 = pdef::proto::size::vec3i(stream, *v3.position); EXPECT_OR_BAIL(len_328); len += len_328; /*position*/ /*4.4*/
            len += stream.sizeOfZigZagVarInt(v3.face); /*0.2*/
        }
        else if (action == pdef::proto::packet_player_auth_input::BlockAction::Action::PredictBreak) { /*8.5*/
            EXPECT_OR_BAIL(v3.position); size_t len_329 = pdef::proto::size::vec3i(stream, *v3.position); EXPECT_OR_BAIL(len_329); len += len_329; /*position*/ /*4.4*/
            len += stream.sizeOfZigZagVarInt(v3.face); /*0.2*/
        }
        else if (action == pdef::proto::packet_player_auth_input::BlockAction::Action::ContinueBreak) { /*8.5*/
            EXPECT_OR_BAIL(v3.position); size_t len_330 = pdef::proto::size::vec3i(stream, *v3.position); EXPECT_OR_BAIL(len_330); len += len_330; /*position*/ /*4.4*/
            len += stream.sizeOfZigZagVarInt(v3.face); /*0.2*/
        }
      }
    }
  ...
  size_t packet_creative_content(pdef::Stream &stream, const pdef::proto::packet_creative_content &obj) {
    ...
    for (const auto &v2 : obj.items) { /*5.20*/
      ...
      size_t len_331 = pdef::proto::size::ItemLegacy(stream, v2.item); EXPECT_OR_BAIL(len_331); len += len_331; /*item*/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_player_enchant_options(pdef::Stream &stream, const pdef::proto::packet_player_enchant_options &obj) {
    ...
    len += stream.sizeOfVarInt(obj.options.size()); /*1.3*/
    for (const auto &v2 : obj.options) {
      size_t len_332 = pdef::proto::size::EnchantOption(stream, v2); EXPECT_OR_BAIL(len_332); len += len_332; /**/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_item_stack_request(pdef::Stream &stream, const pdef::proto::packet_item_stack_request &obj) {
    ...
    for (const auto &v2 : obj.requests) {
      size_t len_333 = pdef::proto::size::ItemStackRequest(stream, v2); EXPECT_OR_BAIL(len_333); len += len_333; /**/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_item_stack_response(pdef::Stream &stream, const pdef::proto::packet_item_stack_response &obj) {
    ...
    for (const auto &v : obj.responses) { size_t len_334 = pdef::proto::size::ItemStackResponses(stream, v); EXPECT_OR_BAIL(len_334); len += len_334; } /*2.5*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_player_armor_damage(pdef::Stream &stream, const pdef::proto::packet_player_armor_damage &obj) {
    size_t len = 0;
  ...
  size_t packet_motion_prediction_hints(pdef::Stream &stream, const pdef::proto::packet_motion_prediction_hints &obj) {
    ...
    size_t len_335 = pdef::proto::size::vec3f(stream, obj.velocity); EXPECT_OR_BAIL(len_335); len += len_335; /*velocity*/ /*4.4*/
    len += 1; /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_animate_entity(pdef::Stream &stream, const pdef::proto::packet_animate_entity &obj) {
  ...
  size_t packet_correct_player_move_prediction(pdef::Stream &stream, const pdef::proto::packet_correct_player_move_prediction &obj) {
    size_t len = 0;
    size_t len_336 = pdef::proto::size::vec3f(stream, obj.position); EXPECT_OR_BAIL(len_336); len += len_336; /*position*/ /*4.4*/
    size_t len_337 = pdef::proto::size::vec3f(stream, obj.delta); EXPECT_OR_BAIL(len_337); len += len_337; /*delta*/ /*4.4*/
    len += 1; /*0.2*/
    len += stream.sizeOfVarInt64(obj.tick); /*0.2*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_item_component(pdef::Stream &stream, const pdef::proto::packet_item_component &obj) {
    ...
    for (const auto &v : obj.entries) { size_t len_338 = pdef::proto::size::ItemComponentList(stream, v); EXPECT_OR_BAIL(len_338); len += len_338; } /*2.5*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_filter_text_packet(pdef::Stream &stream, const pdef::proto::packet_filter_text_packet &obj) {
    size_t len = 0;
  ...
  size_t packet_debug_renderer(pdef::Stream &stream, const pdef::proto::packet_debug_renderer &obj) {
    ...
    switch (type) { /*8.0*/
      ...
      case pdef::proto::packet_debug_renderer::Type::AddCube: { /*8.5*/
          len += stream.sizeOfVarInt(obj.text.length());
          len += obj.text.length(); /*text: pstring*/ /*4.1*/
          EXPECT_OR_BAIL(obj.position); size_t len_339 = pdef::proto::size::vec3f(stream, *obj.position); EXPECT_OR_BAIL(len_339); len += len_339; /*position*/ /*4.4*/
          len += 4; /*0.2*/
          len += 4; /*0.2*/
          len += 4; /*0.2*/
          len += 4; /*0.2*/
  ...
  size_t packet_edu_uri_resource_packet(pdef::Stream &stream, const pdef::proto::packet_edu_uri_resource_packet &obj) {
    size_t len = 0;
    size_t len_340 = pdef::proto::size::EducationSharedResourceURI(stream, obj.resource); EXPECT_OR_BAIL(len_340); len += len_340; /*resource*/ /*4.4*/
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_create_photo(pdef::Stream &stream, const pdef::proto::packet_create_photo &obj) {
    size_t len = 0;
  ...
  size_t packet_update_subchunk_blocks(pdef::Stream &stream, const pdef::proto::packet_update_subchunk_blocks &obj) {
    ...
    for (const auto &v2 : obj.blocks) {
      size_t len_341 = pdef::proto::size::BlockUpdate(stream, v2); EXPECT_OR_BAIL(len_341); len += len_341; /**/ /*4.4*/
    }
    len += stream.sizeOfVarInt(obj.extra.size()); /*1.3*/
    for (const auto &v2 : obj.extra) {
      size_t len_342 = pdef::proto::size::BlockUpdate(stream, v2); EXPECT_OR_BAIL(len_342); len += len_342; /**/ /*4.4*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_photo_info_request(pdef::Stream &stream, const pdef::proto::packet_photo_info_request &obj) {
...
size_t SubChunkEntryWithCaching(pdef::Stream &stream, const pdef::proto::SubChunkEntryWithCaching &obj) {
  ...
  size_t packet_subchunk(pdef::Stream &stream, const pdef::proto::packet_subchunk &obj) {
    ...
    const bool &cache_enabled = obj.cache_enabled; /*0.1*/
    len += stream.sizeOfZigZagVarInt(obj.dimension); /*0.2*/
    size_t len_343 = pdef::proto::size::vec3i(stream, obj.origin); EXPECT_OR_BAIL(len_343); len += len_343; /*origin*/ /*4.4*/
    if (cache_enabled == true) { /*8.1*/
      len += 4; /*2.4*/
      for (const auto &v : obj.entries_SubChunkEntryWithCaching) { size_t len_344 = pdef::proto::size::SubChunkEntryWithCaching(stream, v); EXPECT_OR_BAIL(len_344); len += len_344; } /*2.5*/
    }
    else if (cache_enabled == false) { /*8.1*/
      len += 4; /*2.4*/
      for (const auto &v : obj.entries_SubChunkEntryWithoutCaching) { size_t len_345 = pdef::proto::size::SubChunkEntryWithoutCaching(stream, v); EXPECT_OR_BAIL(len_345); len += len_345; } /*2.5*/
    }
    DBG_PRINT("%s: sized at %lld\n", __func__, len); return len;
  }
  size_t packet_subchunk_request(pdef::Stream &stream, const pdef::proto::packet_subchunk_request &obj) {
    size_t len = 0;
    len += stream.sizeOfZigZagVarInt(obj.dimension); /*0.2*/
    size_t len_346 = pdef::proto::size::vec3i(stream, obj.origin); EXPECT_OR_BAIL(len_346); len += len_346; /*origin*/ /*4.4*/
    len += 4; /*1.3*/

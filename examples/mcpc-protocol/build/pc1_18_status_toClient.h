...
bool tags(pdef::Stream &stream, const pdef::pc1_18_status_toClient::tags &obj) {
  ...
  bool packet(pdef::Stream &stream, const pdef::pc1_18_status_toClient::packet &obj) {
    ...
    switch (V_name) { /*8.0*/
      case pdef::pc1_18_status_toClient::packet::Name::ServerInfo: { /*8.5*/
      PDEF_JSON_putField_OR_BAIL(params_packet_server_info);  pdef::pc1_18_status_toClient::toJSON::packet_server_info(stream, *obj.params_packet_server_info); PDEF_JSON_putToken_OR_BAIL(","); /*packet_server_info*/ /*4.5*/
        break;
      } /*8.7*/
      case pdef::pc1_18_status_toClient::packet::Name::Ping: { /*8.5*/
      PDEF_JSON_putField_OR_BAIL(params_packet_ping);  pdef::pc1_18_status_toClient::toJSON::packet_ping(stream, *obj.params_packet_ping); PDEF_JSON_putToken_OR_BAIL(","); /*packet_ping*/ /*4.5*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/

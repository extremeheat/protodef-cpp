...
bool tags(pdef::Stream &stream, const pdef::pc1_18_login_toServer::tags &obj) {
  ...
  bool packet(pdef::Stream &stream, const pdef::pc1_18_login_toServer::packet &obj) {
    ...
    switch (V_name) { /*8.0*/
      case pdef::pc1_18_login_toServer::packet::Name::LoginStart: { /*8.5*/
        pdef::pc1_18_login_toServer::toJSON::packet_login_start(stream, *obj.params_packet_login_start); /*packet_login_start*/ /*4.5*/
        break;
      } /*8.7*/
      case pdef::pc1_18_login_toServer::packet::Name::EncryptionBegin: { /*8.5*/
        pdef::pc1_18_login_toServer::toJSON::packet_encryption_begin(stream, *obj.params_packet_encryption_begin); /*packet_encryption_begin*/ /*4.5*/
        break;
      } /*8.7*/
      case pdef::pc1_18_login_toServer::packet::Name::LoginPluginResponse: { /*8.5*/
        pdef::pc1_18_login_toServer::toJSON::packet_login_plugin_response(stream, *obj.params_packet_login_plugin_response); /*packet_login_plugin_response*/ /*4.5*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/

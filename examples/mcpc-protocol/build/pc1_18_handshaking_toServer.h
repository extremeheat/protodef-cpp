...
bool tags(pdef::Stream &stream, const pdef::pc1_18_handshaking_toServer::tags &obj) {
  ...
  bool packet_set_protocol(pdef::Stream &stream, const pdef::pc1_18_handshaking_toServer::packet_set_protocol &obj) {
    PDEF_JSON_putToken_OR_BAIL("{");
    PDEF_JSON_putNumber_OR_BAIL(protocolVersion, (int64_t)obj.protocolVersion); /*J0.4*/
    PDEF_JSON_putString_OR_BAIL(serverHost, obj.serverHost) /*serverHost: pstring*/ /*J4.9*/
    PDEF_JSON_putNumber_OR_BAIL(serverPort, (int64_t)obj.serverPort); /*J0.4*/
    PDEF_JSON_putNumber_OR_BAIL(nextState, (int64_t)obj.nextState); /*J0.4*/
    PDEF_JSON_putEndObj_OR_BAIL; PDEF_JSON_FINISH_WRITING; return true;
  }
  bool packet_legacy_server_list_ping(pdef::Stream &stream, const pdef::pc1_18_handshaking_toServer::packet_legacy_server_list_ping &obj) {
    PDEF_JSON_putToken_OR_BAIL("{");
    PDEF_JSON_putNumber_OR_BAIL(payload, (int64_t)obj.payload); /*J0.4*/
    PDEF_JSON_putEndObj_OR_BAIL; PDEF_JSON_FINISH_WRITING; return true;
  }
  bool packet(pdef::Stream &stream, const pdef::pc1_18_handshaking_toServer::packet &obj) {
    PDEF_JSON_putToken_OR_BAIL("{");
    ...
    switch (V_name) { /*8.0*/
      case pdef::pc1_18_handshaking_toServer::packet::Name::SetProtocol: { /*8.5*/
        pdef::pc1_18_handshaking_toServer::toJSON::packet_set_protocol(stream, *obj.params_packet_set_protocol); /*packet_set_protocol*/ /*4.5*/
        break;
      } /*8.7*/
      case pdef::pc1_18_handshaking_toServer::packet::Name::LegacyServerListPing: { /*8.5*/
        pdef::pc1_18_handshaking_toServer::toJSON::packet_legacy_server_list_ping(stream, *obj.params_packet_legacy_server_list_ping); /*packet_legacy_server_list_ping*/ /*4.5*/
        break;
      } /*8.7*/
      default: break; /*avoid unhandled case warning*/
    } /*8.8*/
